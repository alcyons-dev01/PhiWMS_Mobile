...
class ARetournerFournisseurFragment : Fragment()
{
    companion object
    {
        ...
        fun newInstance(liste: ArrayList<Retour_Ligne>): ARetournerFournisseurFragment = ARetournerFournisseurFragment().apply { this.arguments = Bundle().apply { putSerializable(ARG_LISTE, liste) } }
    }

    private lateinit var liste_RetourLigne_LV: ListView
    private var listener: OnElementSelectionneListener? = null
    private lateinit var adapter: Retour_Ligne_RetourFournisseurAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        this.adapter = Retour_Ligne_RetourFournisseurAdapter(requireContext(), liste)
