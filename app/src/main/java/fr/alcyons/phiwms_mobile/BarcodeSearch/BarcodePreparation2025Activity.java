...
public class BarcodePreparation2025Activity  extends ServiceActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        // INTENT
        intent = BarcodePreparation2025Activity.this.getIntent();
        ...
        serialisation = new Serialisation(BarcodePreparation2025Activity.this, db, utilisateurConnecte);
        ...
        boutonSuppression.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BarcodePreparation2025Activity.this.setResult(codeEchangeActivity, scannerSearchOnlyIntent);
                BarcodePreparation2025Activity.this.finish();
            }
        });
        ...
        changeMode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent newIntent = new Intent(BarcodePreparation2025Activity.this, BarcodeCaptureNegativeActivity.class);
                ...
                BarcodePreparation2025Activity.this.startActivityForResult(newIntent, codeEchangesActivites);
                //onBackPressed();
            }
        });
        ...
        ((FloatingActionButton) findViewById(R.id.scannerMode)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent newIntent = new Intent(BarcodePreparation2025Activity.this, ScannerPreparation2025_V2Activity.class);
                Bundle extras = new Bundle();
                extras.putInt("utilisateurConnecteID", intent.getExtras().getInt("utilisateurConnecteID"));
                extras.putInt("serviceSelectionneID", intent.getExtras().getInt("serviceSelectionneID"));
        ...
        ((FloatingActionButton) findViewById(R.id.clavierMode)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent clavierMode_Intent = new Intent(BarcodePreparation2025Activity.this, KeyboardActivity.class);
                ...
                BarcodePreparation2025Activity.this.startActivityForResult(clavierMode_Intent, CodesEchangesActivites.RETOUR_LISTE_CODE_ADRESSAGE);
                onBackPressed();
            }
        });
        ...
        gestureDetector = new GestureDetector(this, new BarcodePreparation2025Activity.CaptureGestureListener());
        scaleGestureDetector = new ScaleGestureDetector(this, new BarcodePreparation2025Activity.ScaleListener());
    }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        List<Produit> produits  = ProduitOpenHelper.getProduitByCodeInconnu(db, best.rawValue.toString());
                        if (produits.size() == 1) {
                            produitCourant = produits.get(0);
                        }
                    }
                            ...
                            else
                            {
                                ...
                                else if(!validationEnCours)
                                {
                                    ...
                                    findViewById(R.id.layout_qte_saisie_lot_preparation).setOnClickListener(view -> {
                                        if(!produitCourant.isSuivi_Serialisation() || produitCourant.isSerialiser_Reception_Delivrance())
                                        {
                                            Context context = BarcodePreparation2025Activity.this;
    ...
    public void afficherSnackBar(String message) {
        ...
        if(message.contentEquals("Produit préparé en intégralité"))
        {
            ...
            ((TextView) findViewById(R.id.quantiteProduit)).setTextColor(BarcodePreparation2025Activity.this.getResources().getColor(R.color.vert));
            ((TextView) findViewById(R.id.quantiteProduit)).setTextSize(TypedValue.COMPLEX_UNIT_DIP, 25);;
            ((LinearLayout) findViewById(R.id.layoutInformations)).setBackground(BarcodePreparation2025Activity.this.getResources().getDrawable(R.drawable.background_detail_preparation_vert));
        ...
        buttonOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(stock_courant != null)
                {
                    ...
                    ElementASynchroniserOpenHelper.toutSynchroniser(BarcodePreparation2025Activity.this, db, utilisateurConnecte, false);
                }
                alertDialog.dismiss();
            }
        });
    ...
    private void verificationEmplacementProduit(Depot_Emplacement emplacement_courant, Produit produitCourant, String stockEmplacement)
    {
        if(stockEmplacement.contentEquals(""))
        {
            ...
            {
                afficherAlerteErreurEmplacement(BarcodePreparation2025Activity.this, BarcodePreparation2025Activity.this.getLayoutInflater(), emplacement_courant.getAdressage(), stock_courant, emplacement_courant);
            }
        }
