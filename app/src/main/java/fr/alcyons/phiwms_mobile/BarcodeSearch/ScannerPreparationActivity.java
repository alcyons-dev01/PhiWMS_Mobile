...
public class ScannerPreparationActivity extends ServiceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //SERIALISATION
        serialisation = new Serialisation(ScannerPreparationActivity.this, db, utilisateurConnecte);
...
//010341285567941717260630108445A@212X6NT7NCP6
//010340093815211117260630108445A@212X6NT7NCP6
        // GRAPHIQUE
...
//0103400930129746 17270531 10AA07243A
                                ...
                                if(emplacement_courant != null)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if(qte_restante == 0)
                                        {
                                            ...
                                            ((TextView) findViewById(R.id.quantiteComplete)).setText(qte_preparer+" / "+qte_demander);
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    int qteProgress = qte_preparer+Integer.parseInt(conditionnement);
    ...
    private void verificationEmplacementProduit(Depot_Emplacement emplacement_courant, Produit produitCourant, String stockEmplacement)
    {
        if(stockEmplacement.contentEquals(""))
        {
            ...
            {
                afficherAlerteErreurEmplacement(ScannerPreparationActivity.this, ScannerPreparationActivity.this.getLayoutInflater(), emplacement_courant.getAdressage(), stock_courant, emplacement_courant);
            }
        }
