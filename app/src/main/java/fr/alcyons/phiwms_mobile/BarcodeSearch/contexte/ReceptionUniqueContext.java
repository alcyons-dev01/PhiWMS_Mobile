...
public class ReceptionUniqueContext extends MainActivity {
    ...
    public ReceptionUniqueContext(final Context context, final SQLiteDatabase db, Utilisateur utilisateurConnecte, List<String> ListeGTIN, int userId, int CommandeId, PH_Reliquat reliquat_courant, PH_Reliquat_Reception_Adapte reliquat_receptionPuiAdapte, Depot_Emplacement emplacementPrecedent, Produit produitPrecedent){
...
/*        else if(emplacement_courant == null)
        ...
        else if(chaine.startsWith("PHITAGPLACE") && nouveau_lot == null)
        {
            ...
            {
                ((BarcodeCaptureActivity) context).afficherSnackBar("Veuillez scanner une référence");
            }
        ...
        else if(emplacement_courant == null && nouveau_lot != null)
        {
            ...
            if(activityName.contentEquals("BarcodeCaptureActivity"))
            {
                ((BarcodeCaptureActivity) context).afficherSnackBar("Veuillez scanner un emplacement");
            }
            else if(activityName.contentEquals("BarcodePreparationActivity"))
            {
                ((BarcodePreparationActivity) context).afficherSnackBar("Veuillez scanner un emplacement");
        ...
        if (data != null) {
            switch (requestCode) {
                case CodesEchangesActivites.RETOUR_SCANNER:
                    ...
                    phReliquatReceptionPUIAdapte_courant = (PH_Reliquat_Reception_Adapte) data.getExtras().getSerializable("reliquatAdapte");
                    break;
            }
        }
    }
