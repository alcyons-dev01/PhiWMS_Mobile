...
public class BarcodeReceptionActivity extends ServiceActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        serialisation = new Serialisation(BarcodeReceptionActivity.this, db, utilisateurConnecte);
        ...
        boutonSuppression.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BarcodeReceptionActivity.this.setResult(codeEchangeActivity, scannerSearchOnlyIntent);
                BarcodeReceptionActivity.this.finish();
            }
        });
        ...
        gestureDetector = new GestureDetector(this, new BarcodeReceptionActivity.CaptureGestureListener());
        scaleGestureDetector = new ScaleGestureDetector(this, new BarcodeReceptionActivity.ScaleListener());
