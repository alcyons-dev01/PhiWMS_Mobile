...
public class PH_Reliquat_ReceptionAdapter extends BaseAdapter {
    ...
    public List<PH_Reliquat_ReceptionAdapter.PH_Reliquat_ReceptionViewHolder> ph_reliquatViewHolderList;

    public PH_Reliquat_ReceptionAdapter(Context context, SQLiteDatabase database, Utilisateur utilisateur) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PH_Reliquat_ReceptionAdapter.PH_Reliquat_ReceptionViewHolder viewHolder = (PH_Reliquat_ReceptionAdapter.PH_Reliquat_ReceptionViewHolder) convertView.getTag();

        if(viewHolder == null)
        {
            viewHolder = new PH_Reliquat_ReceptionAdapter.PH_Reliquat_ReceptionViewHolder();
            switch (rowType) {
                case TYPE_ITEM:
                    convertView =  mInflater.inflate(R.layout.row_reference_detail, parent, false);
