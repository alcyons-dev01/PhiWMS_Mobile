...
public class RetourFournisseurAdapter extends ArrayAdapter implements Filterable {
    ...
    public RetourFournisseurAdapter(Context context, SQLiteDatabase database, List<Retour> retourList, Utilisateur utilisateur) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.row_retour_fournisseur, parent, false);
        }
        ...
        if (retour != null) {
            ...
            String depot_origine = retour.getRef_Depot_Origine();
            ...
            viewHolder.depotOrigine.setText(intitule_tab[0]);
        }
