...
public class ControleDesRetoursAdapter extends ArrayAdapter implements Filterable {
    ...
    public ControleDesRetoursAdapter(Context context, SQLiteDatabase database, List<Retour> retourList, Utilisateur utilisateur) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.row_retour_controle_des_retours, parent, false);
        }
