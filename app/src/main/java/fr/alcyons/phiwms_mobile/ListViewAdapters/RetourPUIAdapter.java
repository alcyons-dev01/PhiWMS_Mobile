...
public class RetourPUIAdapter extends ArrayAdapter implements Filterable {
    ...
    public RetourPUIAdapter(Context context, SQLiteDatabase database, List<Retour> retourList, Utilisateur utilisateur) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.row_retour_pui, parent, false);
        }
