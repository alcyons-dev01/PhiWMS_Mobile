...
public class ListeLotsControleDesRetours2025Activity extends ServiceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pm = ListeLotsControleDesRetours2025Activity.this.getPackageManager();
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ListeLotsControleDesRetours2025Activity.this.finish();
            }
        });
        ...
        ((Button) findViewById(R.id.btnAjoutManuel)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle clicBoutonAjouterManuellement_Bundle = ListeLotsControleDesRetours2025Activity.super.getBundle();
                ...
                Intent clicBoutonAjouterManuellement_Intent = new Intent(ListeLotsControleDesRetours2025Activity.this, CreationLotControleDesRetoursActivity.class);
                clicBoutonAjouterManuellement_Intent.putExtras(clicBoutonAjouterManuellement_Bundle);
                ListeLotsControleDesRetours2025Activity.this.startActivityForResult(clicBoutonAjouterManuellement_Intent, RETOUR_LOT);
            }
        });
        ...
        ((LinearLayout) findViewById(R.id.lancerScan)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle clicBoutonAjoutParScan_Bundle = ListeLotsControleDesRetours2025Activity.super.getBundle();
                ...
                {
                    clicBoutonAjoutParScan_intent = new Intent(ListeLotsControleDesRetours2025Activity.this, ScannerRetourActivity.class);
                }
                else
                {
                ...
                ListeLotsControleDesRetours2025Activity.this.startActivityForResult(clicBoutonAjoutParScan_intent, RETOUR_CODE_GS1);
            }
        });
    }
    ...
    public void onResume()
    {
        ...
        if (produit == null || depot == null) {
            afficherMessageAlerte(ListeLotsControleDesRetours2025Activity.this, ListeLotsControleDesRetours2025Activity.this.getLayoutInflater());
        }
        else
        {
            ...
            }, ListeLotsControleDesRetours2025Activity.this);
    ...
    {
        Context context = ListeLotsControleDesRetours2025Activity.this;
        ...
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                onResume();
                InputMethodManager imm = (InputMethodManager) ListeLotsControleDesRetours2025Activity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public void ClickLigneLot(int position)
    {
        ...
        {
            Alerte.afficherAlerte(ListeLotsControleDesRetours2025Activity.this, "Erreur", "Vous ne pouvez pas préparer un lot vide.", "alerte");
        }
        else
        {
            if(quantiteRestant != 0 && courant.getQte() != 0)
            {
                ...
                {
                    Intent listeZonesIntent = new Intent(ListeLotsControleDesRetours2025Activity.this, ListeZonesActivity.class);
                    Bundle listeZonesBundle = ListeLotsControleDesRetours2025Activity.super.getBundle();
                    ...
                    ListeLotsControleDesRetours2025Activity.this.startActivityForResult(listeZonesIntent, CodesEchangesActivites.RETOUR_ZONE_ET_EMPLACEMENT);
                }
                enregistrementRetourLigne(retourLigne, courant);
                MAJVisuel();
            }
    ...
    private void MAJVisuel()
    {
        if(quantiteRestant == 0)
        {
            ...
            ((LinearLayout) findViewById(R.id.firstRow)).setBackground(ListeLotsControleDesRetours2025Activity.this.getResources().getDrawable(R.drawable.background_detail_preparation_vert));
            ((TextView) findViewById(R.id.qteDeclaree)).setTextColor(ListeLotsControleDesRetours2025Activity.this.getResources().getColor(R.color.vert));
        ...
        {
            //si c'est le cas on cache les autres lignes
            ((LinearLayout) findViewById(R.id.firstRow)).setBackground(ListeLotsControleDesRetours2025Activity.this.getResources().getDrawable(R.drawable.background_detail_preparation_orange));
            ((TextView) findViewById(R.id.qteDeclaree)).setTextColor(ListeLotsControleDesRetours2025Activity.this.getResources().getColor(R.color.orange2));
            ...
            ((TextView) findViewById(R.id.qteDeclaree)).setTextColor(ListeLotsControleDesRetours2025Activity.this.getResources().getColor(R.color.noir));
    ...
    {
        Bundle clicBoutonValider_Bundle = ListeLotsControleDesRetours2025Activity.super.getBundle();
        Intent clicBoutonValider_Intent = new Intent();
        clicBoutonValider_Intent.putExtras(clicBoutonValider_Bundle);
        ListeLotsControleDesRetours2025Activity.this.setResult(RETOUR_LISTE_LOTS, clicBoutonValider_Intent);
        ListeLotsControleDesRetours2025Activity.this.finish();
    }
