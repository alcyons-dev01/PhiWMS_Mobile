...
public class DBOpenHelper extends SQLiteOpenHelper implements Serializable {
    ...
    public static void viderBasesDeDonnees(SQLiteDatabase db) {
        ...
        db.delete(PreparationOpenHelper.Constantes.TABLE_PREPARATION, null, null);
        db.delete(Preparation_LigneOpenHelper.Constantes.TABLE_PREPARATION_LIGNE, null, null);
        ...
        db.delete(FactureOpenHelper.Constantes.TABLE_FACTURE, null, null);
        db.delete(Facture_LigneOpenHelper.Constantes.TABLE_FACTURE_LIGNE, null, null);
        db.delete(Histo_Mvt_StockOpenHelper.Constantes.TABLE_HISTO_MVT_STOCK, null, null);
        db.delete(PH_Mvt_StockOpenHelper.Constantes.TABLE_PH_MVT_STOCK, null, null);
        db.delete(Photo_Stock_DepotOpenHelper.Constantes.TABLE_PHOTO_STOCK_DEPOT, null, null);
        db.delete(Photo_Stock_EtablissementOpenHelper.Constantes.TABLE_PHOTO_STOCK_ETABLISSEMENT, null, null);
        db.delete(Stock_Lot_EmplacementLightOpenHelper.Constantes.TABLE_STOCK_LOT_EMPLACEMENT, null, null);
        db.delete(RRO_LigneOpenHelper.Constantes.TABLE_RRO_LIGNE, null, null);
        ...
        db.delete(Composants_patientOpenHelper.Constantes.TABLE_COMPOSANTS_PATIENT, null, null);
        db.delete(Detail_DotOpenHelper.Constantes.TABLE_DETAIL_DOT, null, null);
        db.delete(Dotation_PatientOpenHelper.Constantes.TABLE_DOTATION_PATIENT, null, null);
        ...
        db.delete(Protocoles_PatientsOpenHelper.Constantes.TABLE_PROTOCOLES_PATIENTS, null, null);
        ...
        db.delete(MVT_DepotsOpenHelper.Constantes.TABLE_MVT_DEPOTS, null, null);
        db.delete(Prescription_patientOpenHelper.Constantes.TABLE_PRESCRIPTION_PATIENT, null, null);
        ...
        db.delete(SurveillanceReferenceOpenHelper.Constantes.TABLE_SURVEILLANCEREFERENCE, null, null);
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(PreparationOpenHelper.Constantes.CREATION_TABLE_PREPARATION);
        db.execSQL(Preparation_LigneOpenHelper.Constantes.CREATION_TABLE_PREPARATION_LIGNE);
        ...
        db.execSQL(FactureOpenHelper.Constantes.CREATION_TABLE_FACTURE);
        db.execSQL(Facture_LigneOpenHelper.Constantes.CREATION_TABLE_FACTURE_LIGNE);
        db.execSQL(Histo_Mvt_StockOpenHelper.Constantes.CREATION_TABLE_HISTO_MVT_STOCK);
        db.execSQL(PH_Mvt_StockOpenHelper.Constantes.CREATION_TABLE_PH_MVT_STOCK);
        db.execSQL(Photo_Stock_DepotOpenHelper.Constantes.CREATION_TABLE_PHOTO_STOCK_DEPOT);
        db.execSQL(Photo_Stock_EtablissementOpenHelper.Constantes.CREATION_TABLE_PHOTO_STOCK_ETABLISSEMENT);
        db.execSQL(Stock_Lot_EmplacementLightOpenHelper.Constantes.CREATION_TABLE_STOCK_LOT_EMPLACEMENT);
        db.execSQL(RRO_LigneOpenHelper.Constantes.CREATION_TABLE_RRO_LIGNE);
        ...
        db.execSQL(Composants_patientOpenHelper.Constantes.CREATION_TABLE_COMPOSANTS_PATIENT);
        db.execSQL(Detail_DotOpenHelper.Constantes.CREATION_TABLE_DETAIL_DOT);
        db.execSQL(Dotation_PatientOpenHelper.Constantes.CREATION_TABLE_DOTATION_PATIENT);
        ...
        db.execSQL(Protocoles_PatientsOpenHelper.Constantes.CREATION_TABLE_PROTOCOLES_PATIENTS);
        ...
        db.execSQL(MVT_DepotsOpenHelper.Constantes.CREATION_TABLE_MVT_DEPOTS);
        db.execSQL(Prescription_patientOpenHelper.Constantes.CREATION_TABLE_PRESCRIPTION_PATIENT);
        ...
        db.execSQL(SurveillanceReferenceOpenHelper.Constantes.CREATION_TABLE_SURVEILLANCEREFERENCE);
