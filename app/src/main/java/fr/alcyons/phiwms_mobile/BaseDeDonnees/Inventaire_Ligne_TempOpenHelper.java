...
public class Inventaire_Ligne_TempOpenHelper extends DBOpenHelper {
    ...
    public static long insererUnInventaire_Ligne_TempEnBDD(SQLiteDatabase db, Inventaire_Ligne_Temp inventaire_ligne_temp) {
        ...
        contentValues.put(Constantes.CLE_COL_INVENTAIRE_DATE_INVENTAIRE_LIGNE_TEMP, inventaire_ligne_temp.getInventaireDate());
        contentValues.put(Constantes.CLE_COL_SYNCHRONISER_INVENTAIRE_LIGNE_TEMP, inventaire_ligne_temp.isSynchroniser());
        contentValues.put(Constantes.CLE_COL_ETABLISSEMENTUID_INVENTAIRE_LIGNE_TEMP, inventaire_ligne_temp.getEtablissement_uid());
    ...
    public static void supprimerTousLesInventaireLigneTempsParInventaireDepotZone(SQLiteDatabase db, int inventaireId, String zone,  Depot depot) {
        db.delete(Constantes.TABLE_INVENTAIRE_LIGNE_TEMP, Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP + " LIKE '"+depot.getDepot_Reference()+"' AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" LIKE '"+zone+"' AND "+Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP+"=?", new String[]{String.valueOf(inventaireId)});
    }
    ...
    public static List<Inventaire_Ligne_Temp> getAllInventaireLigneTempByInventaire(SQLiteDatabase db, int inventaireId) {
        List<Inventaire_Ligne_Temp> inventaireLigneTempList = new ArrayList<>();

        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=?", new String[]{String.valueOf(inventaireId)});
    ...
    public static Inventaire_Ligne_Temp getInventaireLigneByProduitLotPeremptionZoneDepot(SQLiteDatabase db, int inventaireid, int produitid, String numeroLot, String peremptionDate, String zone, String depotReference)
    {
        Inventaire_Ligne_Temp inventaireLigneTemp = null;

        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_PRODUITID_INVENTAIRE_LIGNE_TEMP+ "=? AND "+Constantes.CLE_COL_LOT_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_PEREMPTIONDATE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" LIKE '"+zone+"' AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+" =?", new String[]{String.valueOf(inventaireid), String.valueOf(produitid), numeroLot, peremptionDate, depotReference});
    ...
    public static int getQteInventorieByInventaireProduitZoneDepot(SQLiteDatabase db, int inventaireid, int produitid, String zone, String depotReference)
    {
        int somme = 0;

        Cursor cursor = db.rawQuery("SELECT SUM("+Constantes.CLE_COL_STOCKPHYSIQUE_INVENTAIRE_LIGNE_TEMP+") FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_PRODUITID_INVENTAIRE_LIGNE_TEMP+ "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+"=? AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_STOCKPHYSIQUE_INVENTAIRE_LIGNE_TEMP+" >= 0", new String[]{String.valueOf(inventaireid), String.valueOf(produitid), zone, depotReference});

        if (cursor.moveToFirst()) {
            if (cursor.isNull(0)) {
                somme = -1;
            } else {
                somme = cursor.getInt(0);
            }
        }
        cursor.close();
    ...
    public static List<Inventaire_Ligne_Temp> getInventaireInfoById(SQLiteDatabase db, int inventaireId) {
        List<Inventaire_Ligne_Temp> inventaireLigneTempList = new ArrayList<>();

        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? GROUP BY "+Constantes.CLE_COL_PRODUITID_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP+" ORDER BY "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId)});
    ...
    public static List<Inventaire_Ligne_Temp> getAllInventaireLigneTempByInventaireEtZone(SQLiteDatabase db, int inventaireId, String zone) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" =? ORDER BY "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId), zone});
    ...
    public static List<Inventaire_Ligne_Temp> getAllInventaireLigneTempByInventaireEtZoneEtDepot(SQLiteDatabase db, int inventaireId, String zone, String depotReference) {
        List<Inventaire_Ligne_Temp> inventaireLigneTempList = new ArrayList<>();

        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+" =? ORDER BY "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId), zone, depotReference});
    ...
    public static List<Inventaire_Ligne_Temp> getDistinctInventaireLigneTempByInventaireEtZoneEtDepot(SQLiteDatabase db, int inventaireId, String zone, String depotReference) {
        List<Inventaire_Ligne_Temp> inventaireLigneTempList = new ArrayList<>();

        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+" =? GROUP BY "+Constantes.CLE_COL_PRODUITID_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP+" ORDER BY "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId), zone, depotReference});
    ...
    public static List<Inventaire_Ligne_Temp> getInventaireLigneTempByInventaireEtZoneEtDepotInventorie(SQLiteDatabase db, int inventaireId, String zone, String depotReference) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" LIKE '"+zone+"' AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_STOCKPHYSIQUE_INVENTAIRE_LIGNE_TEMP+" >= 0 ORDER BY "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId), depotReference});
    ...
    public static List<Inventaire_Ligne_Temp> getInventaireLigneTempByInventaireEtZoneEtDepotInventoriProduit(SQLiteDatabase db, int inventaireId, String zone, String depotReference, int idProduit) {
        List<Inventaire_Ligne_Temp> inventaireLigneTempList = new ArrayList<>();

        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_PRODUITID_INVENTAIRE_LIGNE_TEMP+"=? AND "+Constantes.CLE_COL_STOCKPHYSIQUE_INVENTAIRE_LIGNE_TEMP+" >= 0 ORDER BY "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId), zone, depotReference, String.valueOf(idProduit)});
    ...
    public static List<Inventaire_Ligne_Temp> getInventaireLigneTempACompterByInventaireEtZoneEtDepotInventoriProduit(SQLiteDatabase db, int inventaireId, String zone, String depotReference, int idProduit) {
        List<Inventaire_Ligne_Temp> inventaireLigneTempList = new ArrayList<>();

        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" LIKE '"+zone+"' AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_PRODUITID_INVENTAIRE_LIGNE_TEMP+"=? AND "+Constantes.CLE_COL_STOCKPHYSIQUE_INVENTAIRE_LIGNE_TEMP+" < 0 ORDER BY "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId), depotReference, String.valueOf(idProduit)});
    ...
    public static Integer getILTACompte(SQLiteDatabase db, int inventaireId, String zone, String depotReference) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" LIKE '"+zone+"' AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+" LIKE '"+depotReference+"' AND "+Constantes.CLE_COL_STOCKPHYSIQUE_INVENTAIRE_LIGNE_TEMP+" < 0 ORDER BY "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId)});
    ...
    public static Integer getILTTotal(SQLiteDatabase db, int inventaireId, String zone, String depotReference) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" LIKE '"+zone+"' AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+" LIKE '"+depotReference+"' ORDER BY "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+", "+Constantes.CLE_COL_DESIGNATION_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId)});
    ...
    public static List<Inventaire_Ligne_Temp> getAllInventaireLigneTempByInventaireEtZoneEtProduit(SQLiteDatabase db, int inventaireId, String zone, int produitID) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_PRODUITID_INVENTAIRE_LIGNE_TEMP+"=? ORDER BY "+Constantes.CLE_COL_LOT_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId), zone, String.valueOf(produitID)});
    ...
    public static List<Inventaire_Ligne_Temp> getAllInventaireLigneTempByInventaireEtZoneEtProduitEtDepot(SQLiteDatabase db, int inventaireId, String zone, int produitID, String depotReference) {
        List<Inventaire_Ligne_Temp> inventaireLigneTempList = new ArrayList<>();

        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_PRODUITID_INVENTAIRE_LIGNE_TEMP+"=? AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+"=? AND "+Constantes.CLE_COL_STOCKPHYSIQUE_INVENTAIRE_LIGNE_TEMP+" >= 0 ORDER BY "+Constantes.CLE_COL_LOT_INVENTAIRE_LIGNE_TEMP, new String[]{String.valueOf(inventaireId), zone, String.valueOf(produitID), depotReference});
    ...
    public static boolean isInventaireLigneTempCompte(SQLiteDatabase db, int inventaireId, String zone, int produitID, String depotReference) {
        boolean compte = false;

        Cursor cursor = db.rawQuery("SELECT * FROM " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP + " WHERE " + Constantes.CLE_COL_INVENTAIRE_ID_INVENTAIRE_LIGNE_TEMP + "=? AND "+Constantes.CLE_COL_ZONE_INVENTAIRE_LIGNE_TEMP+" =? AND "+Constantes.CLE_COL_PRODUITID_INVENTAIRE_LIGNE_TEMP+"=? AND "+Constantes.CLE_COL_DEPOTREFERENCE_INVENTAIRE_LIGNE_TEMP+"=? AND "+Constantes.CLE_COL_STOCKPHYSIQUE_INVENTAIRE_LIGNE_TEMP+" >= 0", new String[]{String.valueOf(inventaireId), zone, String.valueOf(produitID), depotReference});
    ...
    public static class Constantes implements BaseColumns {
        ...
        public static final String CLE_COL_INVENTAIRE_DATE_INVENTAIRE_LIGNE_TEMP = "inventaireDate";
        public static final int NUM_COL_INVENTAIRE_DATE_INVENTAIRE_LIGNE_TEMP = 27;
        public static final String TYPE_COL_INVENTAIRE_DATE_INVENTAIRE_LIGNE_TEMP = "TEXT";

        public static final String CLE_COL_SYNCHRONISER_INVENTAIRE_LIGNE_TEMP = "synchroniser";
        public static final int NUM_COL_SYNCHRONISER_INVENTAIRE_LIGNE_TEMP = 28;
        public static final String TYPE_COL_SYNCHRONISER_INVENTAIRE_LIGNE_TEMP = "INTEGER";

        public static final String CLE_COL_ETABLISSEMENTUID_INVENTAIRE_LIGNE_TEMP = "Etablissement_UID";
        public static final int NUM_COL_ETABLISSEMENTUID_INVENTAIRE_LIGNE_TEMP = 29;
        public static final String TYPE_COL_ETABLISSEMENTUID_INVENTAIRE_LIGNE_TEMP = "INTEGER";
        public static final String CREATION_TABLE_INVENTAIRE_LIGNE_TEMP = "CREATE TABLE " + Constantes.TABLE_INVENTAIRE_LIGNE_TEMP
                ...
                + Constantes.CLE_COL_INVENTAIRE_DATE_INVENTAIRE_LIGNE_TEMP + " " + Constantes.TYPE_COL_INVENTAIRE_DATE_INVENTAIRE_LIGNE_TEMP + ","
                + Constantes.CLE_COL_SYNCHRONISER_INVENTAIRE_LIGNE_TEMP + " " + Constantes.TYPE_COL_SYNCHRONISER_INVENTAIRE_LIGNE_TEMP + ","
                + Constantes.CLE_COL_ETABLISSEMENTUID_INVENTAIRE_LIGNE_TEMP + " " + Constantes.TYPE_COL_ETABLISSEMENTUID_INVENTAIRE_LIGNE_TEMP
                + ");";
    }
}
