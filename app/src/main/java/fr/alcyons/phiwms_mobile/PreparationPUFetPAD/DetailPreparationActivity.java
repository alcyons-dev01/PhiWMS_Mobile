...
public class DetailPreparationActivity extends ServiceAvecConnexionActivity {
        ...
        if(ph_preparation_Selectionne.getCommentaires() != null && !ph_preparation_Selectionne.getCommentaires().contentEquals(""))
        {
            ((LinearLayout) findViewById(R.id.informationPreparation)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Alerte.afficherAlerteInformation(DetailPreparationActivity.this, getLayoutInflater(), "Commentaire", ph_preparation_Selectionne.getCommentaires(), false, false);
                }
            });
        }
        else
    ...
    public void onResume() {
        ...
        if(!ph_preparation_Selectionne.getListe().contentEquals("ALCYONS_LISTE"))
        {
            ...
            {
                ph_preparation_ligne_preparationLotAdapter = new PH_Preparation_Ligne_PreparationLotAdapter2025_V2(DetailPreparationActivity.this, db, utilisateurConnecte);
            ...
            public void handleOnBackPressed() {
                if(ph_preparation_ligne_preparationLotAdapter != null)
                {
                    if (!ph_preparation_ligne_preparationLotAdapter.ph_preparation_lignes_liste.isEmpty()) {
                        Alerte.afficherAlerteConfirmation(DetailPreparationActivity.this, LayoutInflater.from(DetailPreparationActivity.this), DetailPreparationActivity.super.getBundle(), "Vous allez quitter la préparation, confirmez vous ?", true, false,DetailPreparationActivity.this);
                    } else {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        valider.setOnMenuItemClickListener(menuItem -> {
            ...
            {
                Alerte.afficherAlerteInformation(DetailPreparationActivity.this, getLayoutInflater(), "Attention", "Vous n'avez pas saisie de ligne", false, false);
            }
            else
            {
    ...
    private void onMenuDatamatrixClick() {
        Intent detailPreparation_Intent = new Intent(DetailPreparationActivity.this, ScannerPhotoPreparation.class);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        View view = this.getLayoutInflater().inflate(R.layout.alerte_reliquat, null);

        TextView numeroPreparation = view.findViewById(R.id.numeroDocument);
        TextView depotDestinataire = view.findViewById(R.id.destinataire);
    ...
    public void EnregistrerPreparation() throws JSONException {
        ...
        if(utilisateurConnecte.getEtablissement().toUpperCase().contentEquals("ADH") && listeImprimanteEtiquette.size() > 0)
        {
            if(listeImprimanteEtiquette.size() == 1)
                ...
                afficherAlerteChoixImprimante(DetailPreparationActivity.this, DetailPreparationActivity.this.getLayoutInflater());
        }
        else
        {
    ...
    private void envoyerImpressionZebra(PH_Preparation ph_preparation, String nomImprimante) throws JSONException {
        ...
        JsonObjectRequest obreq = new JsonObjectRequest(Request.Method.POST, urlRequete, body, response -> {
            Toast.makeText(DetailPreparationActivity.this, "Etiquette envoyée", Toast.LENGTH_SHORT).show();
            Intent retourListeIntent = new Intent(DetailPreparationActivity.this, ServicePreparationPufActivity.class);
            if(ph_preparation_Selectionne.getDepotDestinataireReference().contains("-PAD-"))
                retourListeIntent = new Intent(DetailPreparationActivity.this, ServicePreparationPadActivity.class);
            Bundle extras = new Bundle();
            ...
            DetailPreparationActivity.this.finish();
                ...
                error -> {
                    ...
                    {
                        Alerte.afficherAlerte(DetailPreparationActivity.this, "Erreur HTTP", "Erreur lors de l\'impression de l\'étiquette : "+error.toString(), "alerte");
                    }
                    else
                    {
                        Toast.makeText(DetailPreparationActivity.this, "Etiquette envoyée", Toast.LENGTH_SHORT).show();
