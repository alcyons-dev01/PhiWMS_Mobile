...
public class CameraXSourcePreview extends ViewGroup {
    ...
    public CameraXSourcePreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        ...
        mSurfaceView.getHolder().addCallback(new CameraXSourcePreview.SurfaceCallback());
        addView(mSurfaceView);
    }

    @RequiresPermission(Manifest.permission.CAMERA)
    public void start(CameraXSource cameraSource) throws IOException, SecurityException {
    ...
    @RequiresPermission(Manifest.permission.CAMERA)
    public void start(CameraXSource cameraSource, GraphicOverlay overlay) throws IOException, SecurityException {
        mOverlay = overlay;
        start(cameraSource);
    }
