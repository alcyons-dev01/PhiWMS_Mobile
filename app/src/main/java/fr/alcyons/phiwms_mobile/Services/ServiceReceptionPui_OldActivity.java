...
public class ServiceReceptionPui_OldActivity extends ServiceAvecConnexionActivity {
    ...
    private void initObjetGraphique()
    {
        ...
        pm = ServiceReceptionPui_OldActivity.this.getPackageManager();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commandeListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (commandeSelectionne != null) {
                Intent serviceReceptionPui_Intent = new Intent(ServiceReceptionPui_OldActivity.this, DetailReception_V2.class);
                Bundle serviceReceptionPui_Bundle = ServiceReceptionPui_OldActivity.super.getBundle();
                ...
                ServiceReceptionPui_OldActivity.this.startActivity(serviceReceptionPui_Intent);
                ServiceReceptionPui_OldActivity.this.finish();
            }
        });
                            ...
                            if (code != null) {
                                    ...
                                    if (commandeSelectionne == null) {
                                        ...
                                        if (commandeList.isEmpty()) {
                                            ...
                                            Intent intent = new Intent(ServiceReceptionPui_OldActivity.this, NavigationActivity.class);
                                            Bundle extras = new Bundle();
                                            extras.putInt("utilisateurConnecteID", utilisateurConnecte.getId());
                                            intent.putExtras(extras);
                                            ServiceReceptionPui_OldActivity.this.startActivity(intent);
                                            ServiceReceptionPui_OldActivity.this.finish();
                                        }
    ...
    public void onResume() {
        ...
        if (statutConnexion && passageParOnCreate && !connexionDirecte)
        {
            if (!swipeRefreshLayout.isRefreshing()) {
                afficherSpinner(ServiceReceptionPui_OldActivity.this, LayoutInflater.from(ServiceReceptionPui_OldActivity.this));
            }

            RequestQueue requestQueueDestructionUtilisateur = Volley.newRequestQueue(ServiceReceptionPui_OldActivity.this);
        ...
        else
        {
            ...
            if (commandeList.isEmpty()) {
                if(connexionDirecte)
                {
                    ...
                    ServiceReceptionPui_OldActivity.this.startActivity(retourVersServiceConnexionDirectIntent);
                    ServiceReceptionPui_OldActivity.this.finish();
                }
                else
                {
                    ...
                    try {
                        ...
                        if (resultCount == 0) {
                            ...
                            if (erreur.equals(getString(R.string.tokenInvalide))) {
                                Alerte.afficherAlerteInformation(ServiceReceptionPui_OldActivity.this, getLayoutInflater(), "Alerte", "Votre session de connexion est invalide, veuillez vous reconnecter", false, true);
                            } else if (erreur.equals(getString(R.string.tokenExpire))) {
                                Alerte.afficherAlerteInformation(ServiceReceptionPui_OldActivity.this, getLayoutInflater(), "Alerte", "Votre session de connexion est expirée, veuillez vous reconnecter", false, true);
                            } else if (erreur.contentEquals("Aucun PH_Commande trouvé")) {
                                arreterSpinner();
                                Alerte.afficherAlerteInformation(ServiceReceptionPui_OldActivity.this, getLayoutInflater(), "Erreur", "Aucune réception PUI à traiter", false, true);
                            } else {
                                Alerte.afficherAlerteInformation(ServiceReceptionPui_OldActivity.this, getLayoutInflater(), "Erreur", "Veuillez contacter la société Alcyons ! \n Référence à transmettre : Requete Service Reception PUI", false, true);
                            }
                        } else {
    ...
    private void gestionAdapter()
    {
        ...
        commandeReceptionPUIAdapter = new ReceptionAdapter(ServiceReceptionPui_OldActivity.this, db, commandeList);
        commandeListView.setAdapter(commandeReceptionPUIAdapter);
    }

    @NonNull
    private Intent getRetourVersServiceConnexionDirectIntent() {
        Intent retourVersServiceConnexionDirectIntent = new Intent(ServiceReceptionPui_OldActivity.this, ServiceConnexionDirecteActivity.class);
    ...
    {
        Bundle scanDocumentBundle = ServiceReceptionPui_OldActivity.super.getBundle();
        ...
        {
            scanDocumentIntent = new Intent(ServiceReceptionPui_OldActivity.this, ScannerDocumentActivity.class);
        ...
        else
        {
            ...
            {
                scanDocumentIntent = new Intent(ServiceReceptionPui_OldActivity.this, ScannerPhotoIdentificationDocument.class);
