...
public class ListeReassortServiceActivity extends ServiceAvecConnexionActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phReassortListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent listeReassortService_Intent = ListeReassortServiceActivity.this.getListeReassortServiceIntent(phPreparationCourante, PH_ReassortSelectionne);
    ...
    public void onResume() {
        ...
        if (statutConnexion && passageParOnCreate) {
            ...
            if (!swipeRefreshLayout.isRefreshing()) {
                afficherSpinner(ListeReassortServiceActivity.this, LayoutInflater.from(ListeReassortServiceActivity.this));
            }
