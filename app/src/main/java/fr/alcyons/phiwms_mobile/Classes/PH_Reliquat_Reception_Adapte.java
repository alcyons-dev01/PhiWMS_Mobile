...
public class PH_Reliquat_Reception_Adapte implements Serializable {
    ...
    public PH_Reliquat_Reception_Adapte(int phReliquatUID, String Serie, boolean SuiviParSerieActif, boolean SerialiserReception) {
    ...
    public PH_Reliquat_Reception_Adapte(int phReliquatUID, List<Lot> lotList) {
        this.phReliquatUID = phReliquatUID;
        this.lotList = new ArrayList<>();
