...
public class SYS_Mvt_Stock_Type implements Serializable, Comparable {
    ...
    public SYS_Mvt_Stock_Type(JSONObject jsonObject) {
        try {
            ...
            TYM_RUID = OutilsGestionClasses.recupererString(jsonObject.getString("TYM_RUID"));
            TYM_LIB = OutilsGestionClasses.recupererString(jsonObject.getString("TYM_LIB"));
            ...
            TYM_TYPE_MAJ = OutilsGestionClasses.recupererString(jsonObject.getString("TYM_TYPE_MAJ"));
            TYM_DT_CREATION = OutilsGestionClasses.recupererString(jsonObject.getString("TYM_DT_CREATION"));
            ...
            XSYS_USER_MAJ = OutilsGestionClasses.recupererString(jsonObject.getString("XSYS_USER_MAJ"));
