...
public class Frequences {
    ...
    public Frequences(Cursor cursor) {
        ...
        L1 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_L1_FREQUENCES);
        Ma = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_MA_FREQUENCES);
        Mer = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_MER_FREQUENCES);
        J = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_J_FREQUENCES);
        V = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_V_FREQUENCES);
        S = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_S_FREQUENCES);
        D = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_D_FREQUENCES);
        L2 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_L2_FREQUENCES);
        Commentaire = cursor.getString(FrequencesOpenHelper.Constantes.NUM_COL_COMMENTAIRE_FREQUENCES);
        _01 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_01_FREQUENCES);
        _02 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_02_FREQUENCES);
        _03 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_03_FREQUENCES);
        _04 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_04_FREQUENCES);
        _05 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_05_FREQUENCES);
        _06 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_06_FREQUENCES);
        _07 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_07_FREQUENCES);
        _08 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_08_FREQUENCES);
        _09 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_09_FREQUENCES);
        _10 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_10_FREQUENCES);
        _11 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_11_FREQUENCES);
        _12 = OutilsGestionClasses.recupererBooleen(cursor, FrequencesOpenHelper.Constantes.NUM_COL_12_FREQUENCES);
