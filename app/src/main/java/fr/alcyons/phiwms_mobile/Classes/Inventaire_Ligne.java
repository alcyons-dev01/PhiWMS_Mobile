...
public class Inventaire_Ligne implements Serializable, Comparable {
    ...
    public Inventaire_Ligne(Cursor cursor) {
        ...
        this._NePasImprimer = OutilsGestionClasses.recupererBooleen(cursor, Inventaire_LigneOpenHelper.Constantes.NUM_COL__NEPASIMPRIMER_INVENTAIRE_LIGNE);
        ...
        this.suspendu = OutilsGestionClasses.recupererBooleen(cursor, Inventaire_LigneOpenHelper.Constantes.NUM_COL_SUSPENDU_INVENTAIRE_LIGNE);
