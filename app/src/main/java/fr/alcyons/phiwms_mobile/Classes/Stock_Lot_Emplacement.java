...
public class Stock_Lot_Emplacement implements Serializable, Comparable {
    ...
    public Stock_Lot_Emplacement(JSONObject jsonObject) {
        try {
            this.SYS = OutilsGestionClasses.recupererString(jsonObject.getString("SYS"));
            ...
            this.SYS_UniqueID = OutilsGestionClasses.recupererString(jsonObject.getString("SYS_UniqueID"));
            this.Qte_Deplacer = jsonObject.getInt("Qte_Deplacer");
            this.date_dernier_controle = OutilsGestionClasses.recupererString(jsonObject.getString("date_dernier_controle"));
