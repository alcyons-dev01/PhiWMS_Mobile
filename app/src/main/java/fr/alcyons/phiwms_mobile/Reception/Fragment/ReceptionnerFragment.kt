...
class ReceptionnerFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(liste: ArrayList<PH_Reliquat>) = ReceptionnerFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val liste = arguments?.getSerializable(ReceptionnerFragment.Companion.ARG_LISTE) as? ArrayList<PH_Reliquat>
            ?: arrayListOf()
