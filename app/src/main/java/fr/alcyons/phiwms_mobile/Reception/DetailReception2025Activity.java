...
import fr.alcyons.phiwms_mobile.ListViewAdapters.PH_Reliquat_Reception_2025Adapter;
...
public class DetailReception2025Activity  extends ServiceActivity {
    Commande commandeSelectionne;
    List<PH_Reliquat> phReliquatList;

    ListView phReliquatListView;
    PH_Reliquat_Reception_2025Adapter phReliquatReceptionAdapter;
    PH_Reliquat_Reception_2025Adapter.PH_Reliquat_ReceptionViewHolder phReliquatReceptionViewHolder;
        ...
        phReliquatListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (reliquatcourant != null) {
                    Intent detailReception_Intent = new Intent(DetailReception2025Activity.this, ListeLotReception2025_V2Activity.class);
                    Bundle detailReception_Bundle = DetailReception2025Activity.super.getBundle();
                    ...
                    DetailReception2025Activity.this.startActivityForResult(detailReception_Intent, CodesEchangesActivites.RETOUR_LISTE_LOTS);
                }
            }
        });
        ...
        getOnBackPressedDispatcher().addCallback(this, new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                if(!listeReliquatReceptionne.isEmpty())
                    afficherAlerteConfirmationRetour(DetailReception2025Activity.this, LayoutInflater.from(DetailReception2025Activity.this), DetailReception2025Activity.super.getBundle());
                else
                    retourService(DetailReception2025Activity.super.getBundle());
            }
        });
    }
    ...
    public void onResume() {
        ...
        lancerScan.setOnClickListener(view -> {
            ...
            {
                listeLotReception_Intent = new Intent(DetailReception2025Activity.this, ScannerReception2025_V2Activity.class);
            }
            else
            {
                listeLotReception_Intent = new Intent(DetailReception2025Activity.this, BarcodeReception2025Activity.class);
            }
            ...
            DetailReception2025Activity.this.startActivityForResult(listeLotReception_Intent, CodesEchangesActivites.RESULT_BOUTON_FERMETURE_BARCODE_SEARCH);
        });
    ...
    public void envoyerMail(boolean copieMail, final String email) throws JSONException {
        ...
        if (email != null) {
            new DetailReception2025Activity.SendEmailTask().execute(email);
        }

        Toast toast = Toast.makeText(DetailReception2025Activity.this, "Réception effectuée", Toast.LENGTH_SHORT);
    ...
    public void onMenuSaveClick() {
        ...
        {
            afficherAlerteConfirmation(DetailReception2025Activity.this, LayoutInflater.from(DetailReception2025Activity.this));
            item.setVisible(false);
        }
        else
        {
            Toast.makeText(DetailReception2025Activity.this, "Aucune ligne à valider", Toast.LENGTH_SHORT).show();
    ...
    {
        Intent detailReception_Intent = new Intent(DetailReception2025Activity.this, PrisePhoto.class);
        Bundle detailReception_Bundle = DetailReception2025Activity.super.getBundle();
        ...
        detailReception_Intent.putExtras(detailReception_Bundle);
        DetailReception2025Activity.this.startActivityForResult(detailReception_Intent, CodesEchangesActivites.RETOUR_PRISE_PHOTO);
    }
    ...
    public void afficherAlerteConfirmation(Context context, LayoutInflater inflater) {
        ...
        Window window = DetailReception2025Activity.this.getWindow();
        ...
        buttonOk.setOnClickListener(v -> {
            ...
            if(saisie_effectuer)
            {
                ...
                if (!receptionEffectuee) {
                    ...
                    {
                        continuer = Alerte.afficherAlerteList(DetailReception2025Activity.this, "Attention", "Les produits suivant n'ont pas été réceptionnés, continuer ? ", listeProduitRAL, "OuiNon");
                    }
                    ...
                    {
                        Alerte.afficherAlerte(DetailReception2025Activity.this, "Alerte", "Une erreur est survenue, aucun traitement ne sera effectué.", "alerte");
    ...
    public void valider_reception()
    {
        ...
        if(!internet)
        {
            Alerte.afficherAlerte(DetailReception2025Activity.this, "Erreur", "Aucune connexion internet détectée, aucun envoi de mail possible","alerte");
        }
        else
        {
            //Construction mail
            ...
            if (bonLivraisonBitmap != null) {
                ...
                verifyStoragePermissions(DetailReception2025Activity.this);
            }
            ...
            afficherAlerteConfirmationMail(DetailReception2025Activity.this, LayoutInflater.from(DetailReception2025Activity.this), email);
        }
    }
    ...
    {
        Intent detailReceptionIntent = new Intent(DetailReception2025Activity.this, ServiceReceptionPuiActivity.class);
        if(commandeSelectionne.getRef_Depot_Dest().contains("-PAD"))
            detailReceptionIntent = new Intent(DetailReception2025Activity.this, ServiceReceptionPadActivity.class);
        detailReceptionIntent.putExtras(bundle);
        DetailReception2025Activity.this.startActivity(detailReceptionIntent);
        DetailReception2025Activity.this.finish();
    }
    ...
    private class SendEmailTask extends AsyncTask<String, Object, Object> {
        ...
        protected Object doInBackground(String... email) {
            ...
            Mail sender = new Mail(DetailReception2025Activity.this, "dev01@alcyons.fr", true, db, utilisateurConnecte);
            try {
    ...
    private void envoyerImpressionZebra(PH_Reliquat reliquatCourant, String nomImprimante) throws JSONException {
        ...
        JsonObjectRequest obreq = new JsonObjectRequest(Request.Method.POST, urlRequete, body, response -> {
            Toast.makeText(DetailReception2025Activity.this, "Etiquette envoyée", Toast.LENGTH_SHORT).show();
        },
                error -> {
                    Log.e("Etiquette Volley", error.toString());
                    if(!error.toString().contains("\"isOk\":true"))
                    {
                        Alerte.afficherAlerte(DetailReception2025Activity.this, "Erreur HTTP", "Erreur lors de l\'impression de l\'étiquette : "+error.toString(), "alerte");
                    }
                    else
                    {
                        Toast.makeText(DetailReception2025Activity.this, "Etiquette envoyée", Toast.LENGTH_SHORT).show();
