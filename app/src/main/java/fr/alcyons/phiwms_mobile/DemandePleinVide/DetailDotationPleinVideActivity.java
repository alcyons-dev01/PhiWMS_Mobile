...
public class DetailDotationPleinVideActivity extends ServiceAvecConnexionActivity {
                        ...
                        try {
                            ...
                            if (nbResultat == 0) {
                                ...
                                if (string.equals(getString(R.string.tokenInvalide))) {
                                    Alerte.afficherAlerte(DetailDotationPleinVideActivity.this, "Alerte", "Votre session a expirée, veuillez vous reconnecter.", "alerte");
    ...
    public void enregistrerDemande(String commentaire)
    {
        ...
        ActionUtilisateur new_action_utilisateur = new ActionUtilisateur(actionId, utilisateurConnecte.getId(), date_string, serviceActuel.getId(), utilisateurConnecte.getEtablissementId(), "En attente", ph_preparation.getUID(), "", "Demande Plein Vide");
