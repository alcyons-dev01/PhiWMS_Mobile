...
public class ListeProduitActivity extends ServiceActivity implements DemandeParticuliereAdapater.ItemClickListener{
    ...
    public void onClick_Action_envoyerDemande(String motif, String commentaire, boolean urgent) throws ParseException {
        ...
        if (confirmer) {
            ...
            ActionUtilisateur new_action_utilisateur = new ActionUtilisateur(actionId, utilisateurConnecte.getId(), date_string, serviceActuel.getId(), utilisateurConnecte.getEtablissementId(), "En attente", ph_preparation.getUID(), "", "Demande particulière");
