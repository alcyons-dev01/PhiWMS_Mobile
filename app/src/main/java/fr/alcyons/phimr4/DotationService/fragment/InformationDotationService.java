...
public class InformationDotationService extends Fragment {
/*
    Dotation dotation;
    ...
    public void setParametres(Dotation dotation, String dateInventaireString, String dateLivraisonProchaineString, String dateLivraisonSuivanteString) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.information_dotation_service, container, false);
        ...
        *//* Gestion des dates et des DatePicker *//*
        ...
        Depot depot = DepotOpenHelper.getDepotParReference(((MenuActivity) context).db, dotation.getRef_Depot());
        ...
        ((TextView) v.findViewById(R.id.typeDemande)).setText("Dotation Globale");
        ((TextView) v.findViewById(R.id.referenceDepot)).setText(dotation.getRef_Depot());
        ...
        urgent.setChecked(dotation.isURGENCE());
