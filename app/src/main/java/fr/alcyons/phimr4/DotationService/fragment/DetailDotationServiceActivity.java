...
public class DetailDotationServiceActivity extends ServiceActivity {

   /* Dotation dotation;

    // Fragment
    InformationDotationService informationDotationService;
    ListeDetailDots listeDetailDots;
    ...
    * *//*
    public View.OnClickListener clicBoutonSave = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            String Commentaires = informationDotationService.commentaire.getText().toString();
            String PreparationDate = "";
            String LivraisonPrevueDate = informationDotationService.dateLivraisonProchaine.getText().toString();
            String DN_Groupe = "";
            double Montant_HT = 0;
            ...
            String Frequence = "";
            String previsionDateDebut = informationDotationService.datePrevisionDu.getText().toString();
            String previsionDateFin = informationDotationService.datePrevisionAu.getText().toString();
            Boolean URGENT = informationDotationService.urgent.isChecked();
            String Motif = "";
            ...
            for (Demande_PUI demande_pui : listeDetailDots.adapter.demandePuiList
                    ) {
            ...
            if (compteurReussite == listeDetailDots.adapter.demandePuiList.size()) {
                ...
                if (OutilsGestionConnexionReseau.isServerAccessible(DetailDotationServiceActivity.this)) {
                    gestionnaireElementASynchroniser.toutSynchroniser(DetailDotationServiceActivity.this, db, utilisateurConnecte.getToken());
                }

                Toast.makeText(DetailDotationServiceActivity.this, "Demande Dotation Service effectuée", Toast.LENGTH_SHORT).show();
                DetailDotationServiceActivity.this.finish();
                return;
            } else {
                Alerte.afficherAlerte(DetailDotationServiceActivity.this, "Alerte", "Une erreur est survenue", "alerte");
    ...
    *//**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        *//* Code nécessaire à la mise en place d'une Activity contenant des Fragment*//*
        ...
        setContentView(R.layout.activity_detail_dotation_service);
        ...
        *//* Code nécessaire à l'exécution du service *//*
        dotationSelectionneID = intent.getExtras().getInt("dotationSelectionneID");
        dotation = gestionnaireDotation.getDotationByPhiMR4UUID(db, dotationSelectionneID);
    ...
    *//**
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    informationDotationService = new InformationDotationService();
                    informationDotationService.setParametres(dotation, dateInventaire, dateLivraisonProchaine, dateLivraisonSuivante);
                    informationDotationService.setParametres(clicBoutonSave);
                    return informationDotationService;
                case 1:
                    listeDetailDots = new ListeDetailDots();
                    listeDetailDots.setParametres(dotation);
                    return listeDetailDots;
            }
            return null;
        }
