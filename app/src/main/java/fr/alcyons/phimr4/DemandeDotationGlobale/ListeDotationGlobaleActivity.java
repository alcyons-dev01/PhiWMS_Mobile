...
import fr.alcyons.phimr4.DemandeReassort.InformationDemandeReassortActivity;
...
public class ListeDotationGlobaleActivity  extends ServiceAvecConnexionActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phReassortListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Bundle listeReassortService_Bundle = ListeDotationGlobaleActivity.super.getBundle();
                ...
                Intent listeReassortService_Intent = new Intent(ListeDotationGlobaleActivity.this, InformationDemandeReassortActivity.class);
                listeReassortService_Intent.putExtras(listeReassortService_Bundle);
                ListeDotationGlobaleActivity.this.startActivity(listeReassortService_Intent);
                ListeDotationGlobaleActivity.this.finish();
            }
        });
        ...
        dateInventaireTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dateInventairePickerDialog = new DatePickerDialog(ListeDotationGlobaleActivity.this, dateInventaireDatePicker, year, month, day);
        ...
        dateLivraisonProchaineTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dateLivraisonProchainePickerDialog = new DatePickerDialog(ListeDotationGlobaleActivity.this, dateLivraisonProchaineDatePicker, year, month, day);
                ...
                if (!dateMinString.contentEquals("00/00/0000")) {
                    ...
                    dateLivraisonProchainePickerDialog = new DatePickerDialog(ListeDotationGlobaleActivity.this, dateLivraisonProchaineDatePicker, year, month, day);
        ...
        dateLivraisonSuivanteTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dateLivraisonSuivantePickerDialog = new DatePickerDialog(ListeDotationGlobaleActivity.this, dateLivraisonSuivanteDatePicker, year, month, day);
                ...
                if (!dateMinString.contentEquals("00/00/0000")) {
                    ...
                    // Create a new instance of DatePickerDialog and return it
                    dateLivraisonSuivantePickerDialog = new DatePickerDialog(ListeDotationGlobaleActivity.this, dateLivraisonSuivanteDatePicker, year, month, day);
    ...
    public void onResume() {
        ...
        if (OutilsGestionConnexionReseau.isServerAccessible(ListeDotationGlobaleActivity.this) && passageParOnCreate) {

            if (!swipeRefreshLayout.isRefreshing()) {
                mProgressDialog = ProgressDialog.show(ListeDotationGlobaleActivity.this, "Veuillez patienter", "Récupération date livraison en cours");
            }

            RequestQueue requestQueue = Volley.newRequestQueue(ListeDotationGlobaleActivity.this);
            ...
            JsonObjectRequest obreq = new JsonObjectRequest(Request.Method.GET, urlRequete,
                            ...
                            try {
                                ...
                                if (nbResultat == 0) {
                                    ...
                                    if (string.equals(getString(R.string.tokenInvalide))) {
                                        Alerte.afficherAlerte(ListeDotationGlobaleActivity.this, "Alerte", "Votre identifiant de connexion est invalide, veuillez vous reconnecter", "alerte");
                                        DBOpenHelper.viderBasesDeDonnees(db);
                                        ListeDotationGlobaleActivity.this.finishAffinity();
                                        Intent intent = new Intent(ListeDotationGlobaleActivity.this, AuthentificationActivity.class);
                                        ListeDotationGlobaleActivity.this.startActivity(intent);
                                    } else {
                                        vide = true;
                                    }
                                } else {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Log.e("Volley", "Error");
                            Alerte.afficherAlerte(ListeDotationGlobaleActivity.this, "Erreur", "Veuillez contacter la société Alcyons (erreur Volley : Récupération date livraison)", "alerte");
                        }
                    }
            ) {
                @Override
        ...
        if (OutilsGestionConnexionReseau.isServerAccessible(ListeDotationGlobaleActivity.this) && passageParOnCreate) {
            ...
            if (!swipeRefreshLayout.isRefreshing()) {
                mProgressDialog = ProgressDialog.show(ListeDotationGlobaleActivity.this, "Veuillez patienter", "Synchronisation des Reassorts de service en cours");
            }
            ...
            JsonObjectRequest obreq = new JsonObjectRequest(Request.Method.GET, urlRequete,
                            ...
                            try {
                                ...
                                if (nbResultat == 0) {
                                    ...
                                    if (string.equals(getString(R.string.tokenInvalide))) {
                                        ...
                                        Alerte.afficherAlerte(ListeDotationGlobaleActivity.this, "Alerte", "Aucun Reassort de service trouvé", "alerte");
                                    }
                                } else {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Log.e("Volley", "Error");
                            Alerte.afficherAlerte(ListeDotationGlobaleActivity.this, "Erreur", "Veuillez contacter la société Alcyons (erreur Volley : Demande Réassort)", "alerte");
                        }
                    }
            ) {
                @Override
        ...
        phReassortAdapter = new PH_ReassortAdapter(ListeDotationGlobaleActivity.this, phReassortList, db);
        ...
        if (phReassortList.size() == 0) {
            ...
            Intent newIntent = new Intent(ListeDotationGlobaleActivity.this, InformationDemandeReassortActivity.class);
            Bundle extras = ListeDotationGlobaleActivity.super.getBundle();
            ...
            ListeDotationGlobaleActivity.this.startActivity(newIntent);
            ListeDotationGlobaleActivity.this.finish();
        }
    ...
    public void viderTablesConcernees() {
        for (PH_Reassort PH_Reassort : gestionnairePH_Reassort.getPH_ReassortByDepot(db, depot.getDepot_Reference())) {
            for (fr.alcyons.phimr4.Classes.PH_Reassort_Ligne PH_Reassort_Ligne : gestionnairePH_Reassort_Ligne.getAllPH_Reassort_LigneParPH_Reassort(db, PH_Reassort)) {
