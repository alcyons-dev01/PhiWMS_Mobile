                ...
                case CodesEchangesActivites.RESULT_BOUTON_FERMETURE_BARCODE_SEARCH:
                    ...
                    case RETOUR_LOT:
                        ...
                        if (rowID != -1) {
                            ...
                            gestionnaireElementASynchroniser.toutSynchroniser(ListeLotPreparationActivity.this, db, utilisateurConnecte, true);
        ...
        for(final PH_Preparation_Ligne_Preparation_Adapte.LotAdapte lotcourant : lotAdapteList)
        {
            if(lotcourant.getQteSaisie() != 0)
            {
                ...
                if (OutilsGestionConnexionReseau.isServerAccessible(ListeLotPreparationActivity.this))
                {
                    ...
                    String urlRequete = ParametresServeurOpenHelper.getPartieCommuneUrls(db) + DBOpenHelper.Urls.uriRequeteStock_Lot_Emplacements+"produit/"+String.valueOf(produitCode)+"/depot/"+depotReference+"/"+lot+"/"+emplacement+"/verification";
