...
public class CreationLotActivity extends ServiceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePeremptionTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CreationLotActivity.DatePickerFragment newFragment = new CreationLotActivity.DatePickerFragment();
        ...
        qteActuelleEditText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public static class DatePickerFragment extends DialogFragment
        ...
        public void onDateSet(DatePicker view, int year, int month, int day) {
            ...
            ((CreationLotActivity) getActivity()).apparitionValider();
        }
