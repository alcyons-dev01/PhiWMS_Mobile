...
import fr.alcyons.phimr4.Classes.Retour_Ligne_RetourPUI_Adapte;
import fr.alcyons.phimr4.ListViewAdapters.Emplacement_RetourPUIAdapter;
...
public class ListeEmplacementRetourPUIActivity extends ServiceActivity {
    ...
    // Valider le choix de l'emplacement et de la quantité
    View.OnClickListener clicBoutonValider = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            int sommeQteRetournée = 0;

            Retour_Ligne retourLigne = gestionnaireRetour_Ligne.getRetourLigneByID(db, retourLigneSelectionne.getRetourLigneID());
            ...
            for (Retour_Ligne_RetourPUI_Adapte.EmplacementAdapte emplacementAdapte : emplacementAdapteList
                ...
                if (emplacementAdapte.getQte() != 0) {
                    sommeQteRetournée += emplacementAdapte.getQte();
                } else {
            ...
            if (sommeQteRetournée != retourLigne.getQte_avant_retour()) {
    ...
    View.OnClickListener clicBoutonAjoutEmplacement = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            ListeEmplacementRetourPUIActivity.this.startActivityForResult(listeEmplacementRetourPuiIntent, CodesEchangesActivites.RETOUR_ZONE_ET_EMPLACEMENT);
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retourLigneSelectionne = (Retour_Ligne_RetourPUI_Adapte) intent.getExtras().getSerializable("retourLigneAdapte");
        retourLigne = gestionnaireRetour_Ligne.getRetourLigneByID(db, retourLigneSelectionne.getRetourLigneID());
        ...
        if (emplacementAdapteList.size() == 0) {
            Depot_Zone zone = gestionnaireZone.getZoneByDepotEtNom(db, depot, produit.getZone_PUI_Defaut());
            if (zone != null) {
        ...
        boutonAjoutEmplacmeent = (FloatingActionButton) findViewById(R.id.boutonAjoutEmplacmeent);
        boutonSupprimerEmplacement = (FloatingActionButton) findViewById(R.id.boutonSupprimerEmplacement);
        ...
        if (data != null) {
            switch (requestCode) {
                case CodesEchangesActivites.RETOUR_ZONE_ET_EMPLACEMENT:
                    Retour_Ligne_RetourPUI_Adapte.EmplacementAdapte emplacementAdapte = retourLigneSelectionne.new EmplacementAdapte(data.getExtras().getInt("emplacementSelectionneID"), 0);
                ...
                case CodesEchangesActivites.RETOUR_CODE_EMPLACEMENT:
                    String emplacement_scanne = data.getExtras().getString("code");
                    ...
                    if(emplacement != null)
                    {
                        ...
                        if (!emplacementExistantScan) {
                            adapter.add(emplacementAdapteScan);
                            premierPassageScan = true;
                            adapter.notifyDataSetChanged();
                            lot_ajouter = true;
                        }
    ...
    public void onResume() {
        ...
        emplacementListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        int qteAprès = Integer.parseInt(displayValue[aNumberPicker.getValue()]);
                        int difference = 0;
                        ...
                        emplacementAdapte.setQte(qteAprès);
        ...
        if(emplacementAdapteList.size() == 0 && premierPassageScan)
        {
    ...
    {
        Intent scanEmplacement_Intent = null;
        ...
        ListeEmplacementRetourPUIActivity.this.startActivityForResult(scanEmplacement_Intent, CodesEchangesActivites.RETOUR_CODE_EMPLACEMENT);
    }
