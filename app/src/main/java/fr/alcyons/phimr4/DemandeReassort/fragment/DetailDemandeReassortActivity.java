...
public class DetailDemandeReassortActivity extends ServiceActivity {

  /*  PH_Reassort ph_reassort;
    Depot depot;

    // Fragment
    InformationDemandeReassort informationDemandeReassort;
    ListePH_Reassort_Ligne listePH_Reassort_Ligne;
    ...
    * *//*
    public View.OnClickListener clicBoutonSave = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            String Commentaires = informationDemandeReassort.commentaire.getText().toString();
            String PreparationDate = "";
            String LivraisonPrevueDate = informationDemandeReassort.dateLivraisonProchaine.getText().toString();
            String DN_Groupe = "";
            double Montant_HT = 0;
            ...
            String Frequence = "";
            String previsionDateDebut = informationDemandeReassort.datePrevisionDu.getText().toString();
            String previsionDateFin = informationDemandeReassort.datePrevisionAu.getText().toString();
            Boolean URGENT = informationDemandeReassort.urgent.isChecked();
            String Motif = "";
            ...
            for (Demande_PUI demande_pui : listePH_Reassort_Ligne.adapter.demandePuiList
                    ) {
            ...
            if (compteurReussite == listePH_Reassort_Ligne.adapter.demandePuiList.size()) {
                ...
                if (OutilsGestionConnexionReseau.isServerAccessible(DetailDemandeReassortActivity.this)) {
                    gestionnaireElementASynchroniser.toutSynchroniser(DetailDemandeReassortActivity.this, db, utilisateurConnecte.getToken());
                }

                Toast.makeText(DetailDemandeReassortActivity.this, "Demande Réassort Service effectuée", Toast.LENGTH_SHORT).show();
                DetailDemandeReassortActivity.this.finish();
                return;
            } else {
                Alerte.afficherAlerte(DetailDemandeReassortActivity.this, "Alerte", "Une erreur est survenue", "alerte");
    ...
    Integer PH_ReassortSelectionneID;
    ...
    *//**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        *//* Code nécessaire à la mise en place d'une Activity contenant des Fragment*//*
        ...
        setContentView(R.layout.activity_detail_demande_reassort);
        ...
        *//* Code nécessaire à l'exécution du service *//*
        PH_ReassortSelectionneID = intent.getExtras().getInt("PH_ReassortSelectionneID");
    ...
    *//**
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    informationDemandeReassort = new InformationDemandeReassort();
                    informationDemandeReassort.setParametres(ph_reassort, dateInventaire, dateLivraisonProchaine, dateLivraisonSuivante);
                    informationDemandeReassort.setParametres(clicBoutonSave);
                    return informationDemandeReassort;
                case 1:
                    listePH_Reassort_Ligne = new ListePH_Reassort_Ligne();
                    listePH_Reassort_Ligne.setParametres(ph_reassort);
                    return listePH_Reassort_Ligne;
            }
            return null;
        }
