...
public class RetourOpenHelper extends DBOpenHelper {
    ...
    public static long insererUnRetourEnBDD(SQLiteDatabase db, Retour retour) {
        ...
        long rowId = db.insert(TABLE_RETOUR, null, contentValues);
...
/*                                                if (rowID != -1) {
    ...
    public static List<Retour> getAllRetoursByStatutEtEnAttenteDe(SQLiteDatabase db, String statut, String enAttenteDe) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_RETOUR + " WHERE " + Constantes.CLE_COL_STATUT_RETOUR + "=? and " + Constantes.CLE_COL_EN_ATTENTE_DE_RETOUR + "=?", new String[]{statut, enAttenteDe});
    ...
    public static List<Retour> getRetoursByEnAttenteDe(SQLiteDatabase db, String critereEnAttenteDe) {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_RETOUR + " WHERE " + Constantes.CLE_COL_EN_ATTENTE_DE_RETOUR + "=?", new String[]{critereEnAttenteDe});
