...
import static fr.alcyons.phimr4.BaseDeDonnees.ActionUtilisateurOpenHelper.Constantes.CREATION_TABLE_ACTION_UTILISATEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.ActionUtilisateurOpenHelper.Constantes.TABLE_ACTION_UTILISATEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.ActionUtilisateur_LigneOpenHelper.Constantes.CREATION_TABLE_ACTION_UTILISATEUR_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.ActionUtilisateur_LigneOpenHelper.Constantes.TABLE_ACTION_UTILISATEUR_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.CommandeOpenHelper.Constantes.CREATION_TABLE_COMMANDE;
import static fr.alcyons.phimr4.BaseDeDonnees.CommandeOpenHelper.Constantes.TABLE_COMMANDE;
import static fr.alcyons.phimr4.BaseDeDonnees.Commande_LigneOpenHelper.Constantes.CREATION_TABLE_COMMANDE_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.Commande_LigneOpenHelper.Constantes.TABLE_COMMANDE_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.Composants_patientOpenHelper.Constantes.CREATION_TABLE_COMPOSANTS_PATIENT;
import static fr.alcyons.phimr4.BaseDeDonnees.Composants_patientOpenHelper.Constantes.TABLE_COMPOSANTS_PATIENT;
import static fr.alcyons.phimr4.BaseDeDonnees.DepotOpenHelper.Constantes.CREATION_TABLE_DEPOT;
import static fr.alcyons.phimr4.BaseDeDonnees.DepotOpenHelper.Constantes.TABLE_DEPOT;
import static fr.alcyons.phimr4.BaseDeDonnees.Detail_DotOpenHelper.Constantes.CREATION_TABLE_DETAIL_DOT;
import static fr.alcyons.phimr4.BaseDeDonnees.Detail_DotOpenHelper.Constantes.TABLE_DETAIL_DOT;
import static fr.alcyons.phimr4.BaseDeDonnees.DotationOpenHelper.Constantes.CREATION_TABLE_DOTATION;
import static fr.alcyons.phimr4.BaseDeDonnees.DotationOpenHelper.Constantes.TABLE_DOTATION;
import static fr.alcyons.phimr4.BaseDeDonnees.Dotation_PatientOpenHelper.Constantes.CREATION_TABLE_DOTATION_PATIENT;
import static fr.alcyons.phimr4.BaseDeDonnees.Dotation_PatientOpenHelper.Constantes.TABLE_DOTATION_PATIENT;
import static fr.alcyons.phimr4.BaseDeDonnees.EVENTOpenHelper.Constantes.CREATION_TABLE_EVENT;
import static fr.alcyons.phimr4.BaseDeDonnees.EVENTOpenHelper.Constantes.TABLE_EVENT;
import static fr.alcyons.phimr4.BaseDeDonnees.ElementASynchroniserOpenHelper.Constantes.CREATION_TABLE_ELEMENT_A_SYNCHRONISER;
import static fr.alcyons.phimr4.BaseDeDonnees.ElementASynchroniserOpenHelper.Constantes.TABLE_ELEMENT_A_SYNCHRONISER;
import static fr.alcyons.phimr4.BaseDeDonnees.EmplacementOpenHelper.Constantes.CREATION_TABLE_DEPOT_EMPLACEMENT;
import static fr.alcyons.phimr4.BaseDeDonnees.EmplacementOpenHelper.Constantes.TABLE_DEPOT_EMPLACEMENT;
import static fr.alcyons.phimr4.BaseDeDonnees.FactureOpenHelper.Constantes.CREATION_TABLE_FACTURE;
import static fr.alcyons.phimr4.BaseDeDonnees.FactureOpenHelper.Constantes.TABLE_FACTURE;
import static fr.alcyons.phimr4.BaseDeDonnees.Facture_LigneOpenHelper.Constantes.CREATION_TABLE_FACTURE_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.Facture_LigneOpenHelper.Constantes.TABLE_FACTURE_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.FournisseurOpenHelper.Constantes.CREATION_TABLE_FOURNISSEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.FournisseurOpenHelper.Constantes.TABLE_FOURNISSEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.FrequencesOpenHelper.Constantes.CREATION_TABLE_FREQUENCES;
import static fr.alcyons.phimr4.BaseDeDonnees.FrequencesOpenHelper.Constantes.TABLE_FREQUENCES;
import static fr.alcyons.phimr4.BaseDeDonnees.Histo_Mvt_StockOpenHelper.Constantes.CREATION_TABLE_HISTO_MVT_STOCK;
import static fr.alcyons.phimr4.BaseDeDonnees.Histo_Mvt_StockOpenHelper.Constantes.TABLE_HISTO_MVT_STOCK;
import static fr.alcyons.phimr4.BaseDeDonnees.InventaireOpenHelper.Constantes.CREATION_TABLE_INVENTAIRE;
import static fr.alcyons.phimr4.BaseDeDonnees.InventaireOpenHelper.Constantes.TABLE_INVENTAIRE;
import static fr.alcyons.phimr4.BaseDeDonnees.Inventaire_LigneOpenHelper.Constantes.CREATION_TABLE_INVENTAIRE_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.Inventaire_LigneOpenHelper.Constantes.TABLE_INVENTAIRE_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.Inventaire_Ligne_TempOpenHelper.Constantes.CREATION_TABLE_INVENTAIRE_LIGNE_TEMP;
import static fr.alcyons.phimr4.BaseDeDonnees.Inventaire_Ligne_TempOpenHelper.Constantes.TABLE_INVENTAIRE_LIGNE_TEMP;
import static fr.alcyons.phimr4.BaseDeDonnees.MVT_DepotsOpenHelper.Constantes.CREATION_TABLE_MVT_DEPOTS;
import static fr.alcyons.phimr4.BaseDeDonnees.MVT_DepotsOpenHelper.Constantes.TABLE_MVT_DEPOTS;
import static fr.alcyons.phimr4.BaseDeDonnees.NotificationOpenHelper.Constantes.CREATION_TABLE_NOTIFICATION;
import static fr.alcyons.phimr4.BaseDeDonnees.NotificationOpenHelper.Constantes.TABLE_NOTIFICATION;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_Lot_LigneOpenHelper.Constantes.CREATION_TABLE_PH_LOT_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_Lot_LigneOpenHelper.Constantes.TABLE_PH_LOT_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_Mvt_StockOpenHelper.Constantes.CREATION_TABLE_PH_MVT_STOCK;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_Mvt_StockOpenHelper.Constantes.TABLE_PH_MVT_STOCK;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_PatientOpenHelper.Constantes.CREATION_TABLE_PH_PATIENT;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_PatientOpenHelper.Constantes.TABLE_PH_PATIENT;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_PreparationOpenHelper.Constantes.CREATION_TABLE_PH_PREPARATION;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_PreparationOpenHelper.Constantes.TABLE_PH_PREPARATION;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_Preparation_LigneOpenHelper.Constantes.CREATION_TABLE_PH_PREPARATION_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_Preparation_LigneOpenHelper.Constantes.TABLE_PH_PREPARATION_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_ReassortOpenHelper.Constantes.CREATION_TABLE_PH_REASSORT;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_ReassortOpenHelper.Constantes.TABLE_PH_REASSORT;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_Reassort_LigneOpenHelper.Constantes.CREATION_TABLE_PH_REASSORT_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_Reassort_LigneOpenHelper.Constantes.TABLE_PH_REASSORT_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_ReliquatOpenHelper.Constantes.CREATION_TABLE_PH_RELIQUAT;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_ReliquatOpenHelper.Constantes.TABLE_PH_RELIQUAT;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_RetourMotifOpenHelper.Constantes.CREATION_TABLE_PH_RETOURMOTIF;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_RetourMotifOpenHelper.Constantes.TABLE_PH_RETOURMOTIF;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_SerialisationOpenHelper.Constantes.CREATION_TABLE_PH_SERIALISATION;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_UtiliserOpenHelper.Constantes.CREATION_TABLE_PH_UTILISER;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_UtiliserOpenHelper.Constantes.TABLE_PH_UTILISER;
import static fr.alcyons.phimr4.BaseDeDonnees.ParametreUtilisateurOpenHelper.Constantes.CREATION_TABLE_PARAMETRES_UTILISATEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.ParametreUtilisateurOpenHelper.Constantes.TABLE_PARAMETRES_UTILISATEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.ParametresServeurOpenHelper.Constantes.CREATION_TABLE_PARAMETRES_SERVEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.ParametresServeurOpenHelper.Constantes.TABLE_PARAMETRES_SERVEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.Parametres_SerialisationOpenHelper.Constantes.CREATION_TABLE_PARAMETRES_SERIALISATION;
import static fr.alcyons.phimr4.BaseDeDonnees.PerimetreFonctionnelOpenHelper.Constantes.CREATION_TABLE_PERIMETRE_FONCTIONNEL;
import static fr.alcyons.phimr4.BaseDeDonnees.PerimetreFonctionnelOpenHelper.Constantes.TABLE_PERIMETRE_FONCTIONNEL;
import static fr.alcyons.phimr4.BaseDeDonnees.Photo_Stock_DepotOpenHelper.Constantes.CREATION_TABLE_PHOTO_STOCK_DEPOT;
import static fr.alcyons.phimr4.BaseDeDonnees.Photo_Stock_DepotOpenHelper.Constantes.TABLE_PHOTO_STOCK_DEPOT;
import static fr.alcyons.phimr4.BaseDeDonnees.Photo_Stock_EtablissementOpenHelper.Constantes.CREATION_TABLE_PHOTO_STOCK_ETABLISSEMENT;
import static fr.alcyons.phimr4.BaseDeDonnees.Photo_Stock_EtablissementOpenHelper.Constantes.TABLE_PHOTO_STOCK_ETABLISSEMENT;
import static fr.alcyons.phimr4.BaseDeDonnees.PreparationOpenHelper.Constantes.CREATION_TABLE_PREPARATION;
import static fr.alcyons.phimr4.BaseDeDonnees.PreparationOpenHelper.Constantes.TABLE_PREPARATION;
import static fr.alcyons.phimr4.BaseDeDonnees.Preparation_LigneOpenHelper.Constantes.CREATION_TABLE_PREPARATION_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.Preparation_LigneOpenHelper.Constantes.TABLE_PREPARATION_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.Prescription_patientOpenHelper.Constantes.CREATION_TABLE_PRESCRIPTION_PATIENT;
import static fr.alcyons.phimr4.BaseDeDonnees.Prescription_patientOpenHelper.Constantes.TABLE_PRESCRIPTION_PATIENT;
import static fr.alcyons.phimr4.BaseDeDonnees.ProduitOpenHelper.Constantes.CREATION_TABLE_PRODUIT;
import static fr.alcyons.phimr4.BaseDeDonnees.ProduitOpenHelper.Constantes.TABLE_PRODUIT;
import static fr.alcyons.phimr4.BaseDeDonnees.Protocoles_PatientsOpenHelper.Constantes.CREATION_TABLE_PROTOCOLES_PATIENTS;
import static fr.alcyons.phimr4.BaseDeDonnees.Protocoles_PatientsOpenHelper.Constantes.TABLE_PROTOCOLES_PATIENTS;
import static fr.alcyons.phimr4.BaseDeDonnees.RRO_LigneOpenHelper.Constantes.CREATION_TABLE_RRO_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.RRO_LigneOpenHelper.Constantes.TABLE_RRO_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.RetourOpenHelper.Constantes.CREATION_TABLE_RETOUR;
import static fr.alcyons.phimr4.BaseDeDonnees.RetourOpenHelper.Constantes.TABLE_RETOUR;
import static fr.alcyons.phimr4.BaseDeDonnees.Retour_LigneOpenHelper.Constantes.CREATION_TABLE_RETOUR_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.Retour_LigneOpenHelper.Constantes.TABLE_RETOUR_LIGNE;
import static fr.alcyons.phimr4.BaseDeDonnees.SYS_Document_TypeOpenHelper.Constantes.CREATION_TABLE_SYS_DOCUMENT_TYPE;
import static fr.alcyons.phimr4.BaseDeDonnees.SYS_Document_TypeOpenHelper.Constantes.TABLE_SYS_DOCUMENT_TYPE;
import static fr.alcyons.phimr4.BaseDeDonnees.SYS_Mvt_Stock_TypeOpenHelper.Constantes.CREATION_TABLE_SYS_MVT_STOCK_TYPE;
import static fr.alcyons.phimr4.BaseDeDonnees.SYS_Mvt_Stock_TypeOpenHelper.Constantes.TABLE_SYS_MVT_STOCK_TYPE;
import static fr.alcyons.phimr4.BaseDeDonnees.SYS_User_RulesOpenHelper.Constantes.CREATION_TABLE_SYS_USER_RULES;
import static fr.alcyons.phimr4.BaseDeDonnees.SYS_User_RulesOpenHelper.Constantes.TABLE_SYS_USER_RULES;
import static fr.alcyons.phimr4.BaseDeDonnees.ServiceOpenHelper.Constantes.CREATION_TABLE_SERVICE;
import static fr.alcyons.phimr4.BaseDeDonnees.ServiceOpenHelper.Constantes.TABLE_SERVICE;
import static fr.alcyons.phimr4.BaseDeDonnees.StockOpenHelper.Constantes.CREATION_TABLE_STOCK;
import static fr.alcyons.phimr4.BaseDeDonnees.StockOpenHelper.Constantes.TABLE_STOCK;
import static fr.alcyons.phimr4.BaseDeDonnees.Stock_LotOpenHelper.Constantes.CREATION_TABLE_STOCK_LOT;
import static fr.alcyons.phimr4.BaseDeDonnees.Stock_LotOpenHelper.Constantes.TABLE_STOCK_LOT;
import static fr.alcyons.phimr4.BaseDeDonnees.Stock_Lot_EmplacementLightOpenHelper.Constantes.CREATION_TABLE_STOCK_LOT_EMPLACEMENT;
import static fr.alcyons.phimr4.BaseDeDonnees.Stock_Lot_EmplacementLightOpenHelper.Constantes.TABLE_STOCK_LOT_EMPLACEMENT;
import static fr.alcyons.phimr4.BaseDeDonnees.SurveillanceReferenceOpenHelper.Constantes.CREATION_TABLE_SURVEILLANCEREFERENCE;
import static fr.alcyons.phimr4.BaseDeDonnees.TableTraceOpenHelper.Constantes.CREATION_TABLE_TABLE_TRACE;
import static fr.alcyons.phimr4.BaseDeDonnees.UtilisateurOpenHelper.Constantes.CREATION_TABLE_UTILISATEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.UtilisateurOpenHelper.Constantes.TABLE_UTILISATEUR;
import static fr.alcyons.phimr4.BaseDeDonnees.ZoneOpenHelper.Constantes.CREATION_TABLE_DEPOT_ZONE;
import static fr.alcyons.phimr4.BaseDeDonnees.ZoneOpenHelper.Constantes.TABLE_DEPOT_ZONE;
import static fr.alcyons.phimr4.BaseDeDonnees.PH_SerialisationOpenHelper.Constantes.TABLE_PH_SERIALISATION;
import static fr.alcyons.phimr4.BaseDeDonnees.SurveillanceReferenceOpenHelper.Constantes.TABLE_SURVEILLANCEREFERENCE;
import static fr.alcyons.phimr4.BaseDeDonnees.Parametres_SerialisationOpenHelper.Constantes.TABLE_PARAMETRES_SERIALISATION;
import static fr.alcyons.phimr4.BaseDeDonnees.TableTraceOpenHelper.Constantes.TABLE_TABLE_TRACE;
