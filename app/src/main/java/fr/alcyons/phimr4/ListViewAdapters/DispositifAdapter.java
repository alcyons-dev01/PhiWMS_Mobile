...
public class DispositifAdapter extends ArrayAdapter {
    ...
    DispositifAdapter.DispositifFilter filter;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DispositifAdapter.DispositifViewHolder viewHolder = (DispositifAdapter.DispositifViewHolder) convertView.getTag();
        if (viewHolder == null) {
            viewHolder = new DispositifAdapter.DispositifViewHolder();
    ...
    public Filter getFilter() {
        if (filter == null)
            filter = new DispositifAdapter.DispositifFilter();
    ...
    private class DispositifFilter extends android.widget.Filter {
        @Override
