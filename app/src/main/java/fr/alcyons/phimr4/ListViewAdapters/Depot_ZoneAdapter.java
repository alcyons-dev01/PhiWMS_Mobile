...
public class Depot_ZoneAdapter extends ArrayAdapter implements Filterable {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        Depot_ZoneAdapter.Depot_ZoneViewHolder viewHolder = (Depot_ZoneAdapter.Depot_ZoneViewHolder) convertView.getTag();
        if (viewHolder == null) {
            viewHolder = new Depot_ZoneAdapter.Depot_ZoneViewHolder();
    ...
    private class Depot_ZoneFilter extends android.widget.Filter {
        @Override
