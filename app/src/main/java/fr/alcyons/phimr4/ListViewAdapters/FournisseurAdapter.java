...
public class FournisseurAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FournisseurAdapter.FournisseurViewHolder viewHolder = (FournisseurAdapter.FournisseurViewHolder) convertView.getTag();
        if (viewHolder == null) {
            viewHolder = new FournisseurAdapter.FournisseurViewHolder();
