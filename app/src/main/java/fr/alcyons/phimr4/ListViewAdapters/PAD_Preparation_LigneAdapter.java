...
public class PAD_Preparation_LigneAdapter extends ArrayAdapter implements Filterable {
    ...
    Context context;
    SQLiteDatabase db;
    PAD_Preparation_LigneAdapter.ProduitFilter produitFilter;
    ...
    public Filter getFilter() {
        if (produitFilter == null)
            produitFilter = new PAD_Preparation_LigneAdapter.ProduitFilter();
    ...
    private class ProduitFilter extends android.widget.Filter {
        @Override
