...
import fr.alcyons.phimr4.Quarantaine.DetailQuarantaineActivity;
...
public class Retour_Ligne_QuarantaineAdapter extends ArrayAdapter {
    ...
    public void setModeModif(boolean modeModif, Retour_Ligne_QuarantaineAdapter.Retour_LigneViewHolder viewHolder) {
        if (modeModif) {
