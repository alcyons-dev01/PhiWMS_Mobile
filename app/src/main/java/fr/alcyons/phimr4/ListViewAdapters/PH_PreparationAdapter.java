...
public class PH_PreparationAdapter extends ArrayAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PH_PreparationAdapter.PH_PreparationViewHolder viewHolder = (PH_PreparationAdapter.PH_PreparationViewHolder) convertView.getTag();
        if (viewHolder == null) {
            // Récupération des objets graphiques
            viewHolder = new PH_PreparationAdapter.PH_PreparationViewHolder();
