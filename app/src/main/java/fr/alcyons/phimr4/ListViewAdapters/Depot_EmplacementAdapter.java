...
public class Depot_EmplacementAdapter extends ArrayAdapter implements Filterable {
    ...
    Context context;
    SQLiteDatabase db;
    Depot_EmplacementAdapter.Depot_EmplacementFilter filter;
    ...
    public Depot_EmplacementFilter getFilter() {
        if (filter == null)
            filter = new Depot_EmplacementAdapter.Depot_EmplacementFilter();
        return filter;
    }
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        Depot_EmplacementAdapter.Depot_EmplacementViewHolder viewHolder = (Depot_EmplacementAdapter.Depot_EmplacementViewHolder) convertView.getTag();
        if (viewHolder == null) {
