...
public class Produit_IdentificationParScanAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Produit_IdentificationParScanAdapter.ProduitViewHolder viewHolder = (Produit_IdentificationParScanAdapter.ProduitViewHolder) convertView.getTag();
        if (viewHolder == null) {
            viewHolder = new Produit_IdentificationParScanAdapter.ProduitViewHolder();
