...
public class Stock_Lot_EmplacementAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Stock_Lot_EmplacementAdapter.Stock_Lot_EmplacementViewHolder viewHolder = (Stock_Lot_EmplacementAdapter.Stock_Lot_EmplacementViewHolder) convertView.getTag();
        if (viewHolder == null) {
            viewHolder = new Stock_Lot_EmplacementAdapter.Stock_Lot_EmplacementViewHolder();
