...
public class PH_Preparation_PreparationAdapter extends ArrayAdapter implements Filterable {
    ...
    SQLiteDatabase db;
    PH_Preparation_PreparationAdapter.PH_Preparation_PreparationFilter filter;
    ...
    public PH_Preparation_PreparationFilter getFilter() {
        if (filter == null)
            filter = new PH_Preparation_PreparationAdapter.PH_Preparation_PreparationFilter();
        return filter;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PH_Preparation_PreparationAdapter.PH_PreparationPreparationViewHolder viewHolder = (PH_Preparation_PreparationAdapter.PH_PreparationPreparationViewHolder) convertView.getTag();
        if (viewHolder == null) {
            // Récupération des objets graphiques
            viewHolder = new PH_Preparation_PreparationAdapter.PH_PreparationPreparationViewHolder();
