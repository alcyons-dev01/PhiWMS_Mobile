 ...
 */
package fr.alcyons.phimr4.PrisePhoto.camera;
...
public class CameraSource {
    ...
    public static GraphicOverlay<PrisePhotoGraphic> mGraphicOverlay;
    ...
    public static class Builder {
         ...
         */
        public CameraSource build(GraphicOverlay<PrisePhotoGraphic> graphicOverlay) {
