...
public class Inventaire_Ligne_Temp implements Serializable, Comparable {
    ...
    public Inventaire_Ligne_Temp(Cursor cursor) {
        ...
        this._NePasImprimer = recupererBooleen(cursor, Inventaire_Ligne_TempOpenHelper.Constantes.NUM_COL__NEPASIMPRIMER_INVENTAIRE_LIGNE_TEMP);
        ...
        this.suspendu = recupererBooleen(cursor, Inventaire_Ligne_TempOpenHelper.Constantes.NUM_COL_SUSPENDU_INVENTAIRE_LIGNE_TEMP);
