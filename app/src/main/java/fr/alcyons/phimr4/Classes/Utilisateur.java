...
public class Utilisateur implements Serializable {
    ...
    public Utilisateur(Cursor cursor) {
        ...
        this.active = recupererBooleen(cursor, UtilisateurOpenHelper.Constantes.NUM_COL_ACTIVE_UTILISATEUR);
        this.planHabilitation = cursor.getInt(UtilisateurOpenHelper.Constantes.NUM_COL_PLAN_HABILITATION_UTILISATEUR);
        this.bloque = recupererBooleen(cursor, UtilisateurOpenHelper.Constantes.NUM_COL_BLOQUE_UTILISATEUR);
    ...
    public Utilisateur(JSONObject utilisateurJson) {
        try {
            ...
            this.active = recupererBooleen(utilisateurJson, "active");
            this.planHabilitation = utilisateurJson.getInt("planHabilitation");
            this.bloque = recupererBooleen(utilisateurJson, "bloque");
