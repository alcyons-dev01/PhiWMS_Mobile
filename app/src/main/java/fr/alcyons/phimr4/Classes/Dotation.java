...
public class Dotation implements Serializable, Comparable {
    ...
    public Dotation(JSONObject jsonObject) {
        try {
            ...
            this.Ref_Depot = recupererString(jsonObject.getString("Ref_Depot"));
            this.Début = recupererString(jsonObject.getString("Début"));
            this.Fin = recupererString(jsonObject.getString("Fin"));
            ...
            this.Tournee_Reference = recupererString(jsonObject.getString("Tournee_Reference"));
    ...
    public Dotation(Cursor cursor) {
        ...
        this.Interrompu = recupererBooleen(cursor, DotationOpenHelper.Constantes.NUM_COL_INTERROMPU_DOTATION);
        ...
        this.URGENCE = recupererBooleen(cursor, DotationOpenHelper.Constantes.NUM_COL_URGENCE_DOTATION);
        this.SECURISE = recupererBooleen(cursor, DotationOpenHelper.Constantes.NUM_COL_SECURISE_DOTATION);
        this.TauxStockIdeal = cursor.getInt(DotationOpenHelper.Constantes.NUM_COL_TAUXSTOCKIDEAL_DOTATION);
        this.INSTALLATION = recupererBooleen(cursor, DotationOpenHelper.Constantes.NUM_COL_INSTALLATION_DOTATION);
        this.PLEINVIDE = recupererBooleen(cursor, DotationOpenHelper.Constantes.NUM_COL_PLEINVIDE_DOTATION);
