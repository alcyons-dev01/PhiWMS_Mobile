...
public class DetailZoneActivity extends ServiceActivity {
    ...
    public void onResume() {
        ...
        depotZoneSelectionne = gestionnaireZone.getUneZoneByID(db, intent.getExtras().getInt("zoneSelectionneeID"));

        if (depotZoneSelectionne != null) {
            depotZoneSelectionne.setEmplacements(gestionnaireEmplacement.getEmplacementsParZone(db, depotZoneSelectionne));
            ...
            List<Depot_Emplacement> depotEmplacementList = gestionnaireEmplacement.getEmplacementsParZone(db, depotZoneSelectionne);

            ((LinearLayout) findViewById(R.id.listEmplacement)).removeAllViews();
            for (Depot_Emplacement depotEmplacement : depotEmplacementList) {

                View vi = getLayoutInflater().inflate(R.layout.row_depot_emplacement, null);
            ...
            String nbEmplacements = String.valueOf(depotEmplacementList.size()) + " emplacements";
