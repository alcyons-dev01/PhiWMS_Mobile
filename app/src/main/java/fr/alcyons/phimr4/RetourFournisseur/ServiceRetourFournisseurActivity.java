package fr.alcyons.phimr4.RetourFournisseur;
...
public class ServiceRetourFournisseurActivity extends ServiceAvecConnexionActivity {
    ...
    public void onResume() {
        ...
        if (OutilsGestionConnexionReseau.isServerAccessible(ServiceRetourFournisseurActivity.this) && passageParOnCreate && !connexionDirecte) {
            ...
            RequestQueue requestQueueDestructionUtilisateur = Volley.newRequestQueue(ServiceRetourFournisseurActivity.this);
                            ...
                            try {
                                ...
                                if (nbResultat == 0) {
                                    ...
                                    for (int i = 0; i < retoursJson.length(); i++) {
                                        ...
                                        if (retour.getEn_Attente_de().equals(getString(R.string.RetourFRSDemandé)) && retour.getStatut().equals(getString(R.string.statutEncours))) {
            ...
            listeRetours = gestionnaireRetour.getAllRetoursByStatutEtEnAttenteDe(db, getString(R.string.statutEncours), getString(R.string.RetourFRSDemandé));
            if (listeRetours.size() == 0) {
                if(connexionDirecte)
                {
    ...
    public void viderTablesConcernees() {
        for (Retour retour : gestionnaireRetour.getAllRetoursByStatutEtEnAttenteDe(db, getString(R.string.statutEncours), getString(R.string.RetourFRSDemandé))
                ) {
    ...
    public void lancerScan()
    {
        ...
        ServiceRetourFournisseurActivity.this.startActivityForResult(scanDocumentIntent, CodesEchangesActivites.RETOUR_DOCUMENT);
    }
