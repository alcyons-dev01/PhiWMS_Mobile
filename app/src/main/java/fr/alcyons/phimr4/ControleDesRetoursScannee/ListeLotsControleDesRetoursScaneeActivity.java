...
import fr.alcyons.phimr4.ListViewAdapters.Lot_ControleDesRetoursScanneeAdapter;
...
public class ListeLotsControleDesRetoursScaneeActivity  extends ServiceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pm = ListeLotsControleDesRetoursScaneeActivity.this.getPackageManager();
        ...
        if (produit == null || depot == null) {
            Alerte.afficherAlerte(ListeLotsControleDesRetoursScaneeActivity.this, "Alerte", "Un problème a été constaté en Base de données, veuillez synchroniser l'application ou contacter la société Alcyons (service Contrôle des retours", "alerte");
            ListeLotsControleDesRetoursScaneeActivity.this.finish();
            return;
        }
    ...
    public void onResume()
    {
        ...
        adapter = new Lot_ControleDesRetoursScanneeAdapter(ListeLotsControleDesRetoursScaneeActivity.this, lotAdaptesList, db, retourLigneAdapteSelectionne, depot.getStructure(), quantiteRestant);
        listView.setDivider(footer);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(final AdapterView<?> parent, final View view, final int position, long id) {
                ...
                {
                    ((LinearLayout) findViewById(R.id.firstRow)).setBackground(ListeLotsControleDesRetoursScaneeActivity.this.getResources().getDrawable(R.drawable.background_detail_preparation_orange));
                    ...
                    if(data.getExtras() != null)
                    {
                        ...
                        if(numLot != null)
                        {
                            ...
                            if(index_lot_existant == -1)
                            {
                                ...
                                Toast.makeText(ListeLotsControleDesRetoursScaneeActivity.this, "L'élément a bien été ajouté à la liste", Toast.LENGTH_SHORT);
                            ...
                            else
                            {
                                ...
                                if(quantite_saisie != lotAdaptesListDeBase.get(index_lot_existant).getQteActuelle())
                                {
                                    ...
                                    if(stock_courant != null)
                                    {
                                        ...
                                        if (rowID != -1) {
                                            gestionnaireElementASynchroniser.ajouterElementASynchroniser(db, Stock_Lot_EmplacementLightOpenHelper.Constantes.TABLE_STOCK_LOT_EMPLACEMENT, stock_courant.getPhiMR4UUID(), stock_courant.get_UID(), DBOpenHelper.ActionsEAS.MAJ);
                                        }
                                    }
                                }
    ...
    {
        Bundle clicBoutonAjouterManuellement_Bundle = ListeLotsControleDesRetoursScaneeActivity.super.getBundle();
        ...
        Intent clicBoutonAjouterManuellement_Intent = new Intent(ListeLotsControleDesRetoursScaneeActivity.this, CreationLotControleDesRetoursScanneeActivity.class);
        clicBoutonAjouterManuellement_Intent.putExtras(clicBoutonAjouterManuellement_Bundle);
        ListeLotsControleDesRetoursScaneeActivity.this.startActivityForResult(clicBoutonAjouterManuellement_Intent, RETOUR_LOT);
    }
    ...
    {
        Context context = ListeLotsControleDesRetoursScaneeActivity.this;
        Retour_Ligne_ControleRetour_Adapte.LotAdapte courant = lotAdaptesList.get(position);
        ...
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                MAJVisuel();
                adapter.notifyDataSetChanged();
                InputMethodManager imm = (InputMethodManager) ListeLotsControleDesRetoursScaneeActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    private void MAJVisuel()
    {
        ...
        if(quantiteRestant == 0)
        {
            ...
            ((LinearLayout) findViewById(R.id.firstRow)).setBackground(ListeLotsControleDesRetoursScaneeActivity.this.getResources().getDrawable(R.drawable.background_detail_preparation_vert));
            ((TextView) findViewById(R.id.qteDeclaree)).setTextColor(ListeLotsControleDesRetoursScaneeActivity.this.getResources().getColor(R.color.vert));
        ...
        else
        {
            //si c'est le cas on cache les autres lignes
            ((LinearLayout) findViewById(R.id.firstRow)).setBackground(ListeLotsControleDesRetoursScaneeActivity.this.getResources().getDrawable(R.drawable.background_detail_preparation_orange));
            ((TextView) findViewById(R.id.qteDeclaree)).setTextColor(ListeLotsControleDesRetoursScaneeActivity.this.getResources().getColor(R.color.orange2));
            ...
            ((TextView) findViewById(R.id.qteDeclaree)).setTextColor(ListeLotsControleDesRetoursScaneeActivity.this.getResources().getColor(R.color.noir));
    ...
    public void onMenuSaveClick()
    {
        ...
        Bundle clicBoutonValider_Bundle = ListeLotsControleDesRetoursScaneeActivity.super.getBundle();
        ...
        ListeLotsControleDesRetoursScaneeActivity.this.setResult(RETOUR_LISTE_LOTS, clicBoutonValider_Intent);
        ListeLotsControleDesRetoursScaneeActivity.this.finish();
    }
    ...
    View.OnClickListener clicBoutonAjoutParScan = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            gestionLot();
            Bundle clicBoutonAjoutParScan_Bundle = ListeLotsControleDesRetoursScaneeActivity.super.getBundle();
            ...
            {
                clicBoutonAjoutParScan_intent = new Intent(ListeLotsControleDesRetoursScaneeActivity.this, ScannerPreparationActivity.class);
            }
            else
            {
                if(pm.hasSystemFeature(PackageManager.FEATURE_CAMERA))
                {
                    clicBoutonAjoutParScan_intent = new Intent(ListeLotsControleDesRetoursScaneeActivity.this, BarcodePreparationActivity.class);
                }
                else
                {
                    clicBoutonAjoutParScan_intent = new Intent(ListeLotsControleDesRetoursScaneeActivity.this, ScannerPreparationActivity.class);
            ...
            ListeLotsControleDesRetoursScaneeActivity.this.startActivityForResult(clicBoutonAjoutParScan_intent, RETOUR_CODE_GS1);
        }
    };
