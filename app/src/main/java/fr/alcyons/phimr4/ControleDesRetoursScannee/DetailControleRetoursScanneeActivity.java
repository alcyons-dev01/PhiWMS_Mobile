...
import fr.alcyons.phimr4.ListViewAdapters.Retour_Ligne_ControleRetoursAdapter;
...
public class DetailControleRetoursScanneeActivity  extends ServiceAvecConnexionActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = DetailControleRetoursScanneeActivity.this;

        // Récupération des variables globales
        retourSelectionne = gestionnaireRetour.getRetourByID(db, intent.getExtras().getInt("retourSelectionneID"));

        serialisation = new Serialisation(DetailControleRetoursScanneeActivity.this, db, utilisateurConnecte);
        ...
        retourLigneControleRetourAdapteListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Bundle DetailControleRetours_Bundle = DetailControleRetoursScanneeActivity.super.getBundle();
                if(retourLigne != null)
                ...
                Intent DetailControleRetours_Intent = new Intent(DetailControleRetoursScanneeActivity.this, ListeLotsControleDesRetoursScaneeActivity.class);
                DetailControleRetours_Intent.putExtras(DetailControleRetours_Bundle);
                DetailControleRetoursScanneeActivity.this.startActivityForResult(DetailControleRetours_Intent, CodesEchangesActivites.RETOUR_LISTE_LOTS);
            }
        });
        ...
        pm = DetailControleRetoursScanneeActivity.this.getPackageManager();
        liste_retour_ligne =  gestionnaireRetour_Ligne.getAllRetourLignesByRetour(db, retourSelectionne);
    ...
    public void onResume() {
        super.onResume();
        if (OutilsGestionConnexionReseau.isServerAccessible(DetailControleRetoursScanneeActivity.this) && passageParOnCreate) {

            if (!swipeRefreshLayout.isRefreshing()) {
                mProgressDialog = ProgressDialog.show(DetailControleRetoursScanneeActivity.this, "Veuillez patienter", "Synchronisation des stocks en cours");
            }

            RequestQueue requestQueue = Volley.newRequestQueue(DetailControleRetoursScanneeActivity.this);
            ...
            JsonObjectRequest obreq = new JsonObjectRequest(Request.Method.GET, urlRequete,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Alerte.afficherAlerte(DetailControleRetoursScanneeActivity.this, "Erreur", "Veuillez contacter la société Alcyons (erreur Volley : Contrôle des retours)", "alerte");
                        }
                    }
            ) {
    ...
    public void onMenuSaveClick() {
        ...
        if (compteurReussiteGlobale != retourLigneControleRetoursAdapter.retour_Lignes.size()) {
            ...
            Alerte.afficherAlerte(DetailControleRetoursScanneeActivity.this, "Alerte", "Une erreur est survenue, aucun traitement ne sera effectué.", "alerte");
            gestionnaireElementASynchroniser.viderTableElementASynchroniser(db);
            DetailControleRetoursScanneeActivity.this.finish();
            return;
        }

        Toast.makeText(DetailControleRetoursScanneeActivity.this, "Retour contrôlé", Toast.LENGTH_SHORT).show();

        // Si possible, on essaie de mettre à jour les éléments
        if (OutilsGestionConnexionReseau.isServerAccessible(DetailControleRetoursScanneeActivity.this)) {
            gestionnaireElementASynchroniser.toutSynchroniser(DetailControleRetoursScanneeActivity.this, db, utilisateurConnecte, true);
        }


        Intent validationRetour_Intent = new Intent(DetailControleRetoursScanneeActivity.this, ServiceControleRetoursScanneeActivity.class);
        Bundle validationRetours_Bundle = DetailControleRetoursScanneeActivity.super.getBundle();
        validationRetour_Intent.putExtras(validationRetours_Bundle);
        DetailControleRetoursScanneeActivity.this.startActivity(validationRetour_Intent);
        DetailControleRetoursScanneeActivity.this.finish();
        return;
    }

    public void affichageInfoCommentaire(View v) {
        String commentaireRetourner = Alerte.afficherAlerteInfoCommantaire(DetailControleRetoursScanneeActivity.this, retourSelectionne.getCommentaire());
    ...
    public void onBackPressed() {
        Intent detailControleIntent = new Intent(DetailControleRetoursScanneeActivity.this, ServiceControleRetoursScanneeActivity.class);
        ...
        DetailControleRetoursScanneeActivity.this.startActivity(detailControleIntent);
        DetailControleRetoursScanneeActivity.this.finish();
    }
    ...
    public void lancerScanner()
    {
        ...
        {
            controleDesRetour_Intent = new Intent(DetailControleRetoursScanneeActivity.this, ScannerPreparationActivity.class);
        }
        else
        {
            if(pm.hasSystemFeature(PackageManager.FEATURE_CAMERA))
            {
                controleDesRetour_Intent = new Intent(DetailControleRetoursScanneeActivity.this, BarcodePreparationActivity.class);
        ...
        DetailControleRetoursScanneeActivity.this.startActivityForResult(controleDesRetour_Intent, CodesEchangesActivites.RESULT_BOUTON_FERMETURE_BARCODE_SEARCH);
    }
    ...
    {
        retourLigneControleRetoursAdapter = new Retour_Ligne_ControleRetoursAdapter(DetailControleRetoursScanneeActivity.this, retourLigneControleRetourAdapteList, db);
