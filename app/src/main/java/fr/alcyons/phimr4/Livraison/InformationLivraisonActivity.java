...
import fr.alcyons.phimr4.ListViewAdapters.PH_Preparation_Ligne_LivraisonAdapter;
...
public class InformationLivraisonActivity extends ServiceActivity {
    ...
    View.OnClickListener onClickListenerValider = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            subject = "PhiMR4 - "+ depot.getNom() + " - Livraisons N°" + ph_preparation_Selectionne.getUID() + " - " + date;
