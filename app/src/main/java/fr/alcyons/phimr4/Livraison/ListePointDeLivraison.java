...
import fr.alcyons.phimr4.ListViewAdapters.ListePointDeLivraisonAdapter;
...
public class ListePointDeLivraison extends ServiceAvecConnexionActivity {
    ...
    public void onResume() {
        ...
        if (OutilsGestionConnexionReseau.isServerAccessible(ListePointDeLivraison.this) && passageParOnCreate && !connexionDirecte) {
            ...
            if (ph_preparation_List.size() == 0) {
                ...
                {
                    Intent serviceLivraison_Intent = new Intent(ListePointDeLivraison.this, NavigationActivity.class);
                    Bundle serviceLivraison_Bundle = ListePointDeLivraison.super.getBundle();
                    serviceLivraison_Intent.putExtras(serviceLivraison_Bundle);
                    ListePointDeLivraison.this.startActivity(serviceLivraison_Intent);
                    ListePointDeLivraison.this.finish();
    ...
    {
        Bundle scanDocumentBundle = ListePointDeLivraison.super.getBundle();
        ...
        {
            scanDocumentIntent = new Intent(ListePointDeLivraison.this, ScannerDocumentActivity.class);
