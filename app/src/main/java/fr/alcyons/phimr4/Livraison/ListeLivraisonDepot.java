package fr.alcyons.phimr4.Livraison;
...
import fr.alcyons.phimr4.ListViewAdapters.ListeLivraisonDepotAdapter;
import fr.alcyons.phimr4.Outils.Alerte;
import fr.alcyons.phimr4.Outils.CodesEchangesActivites;
import fr.alcyons.phimr4.Outils.Dialogue;
import fr.alcyons.phimr4.Outils.Mail;
import fr.alcyons.phimr4.Outils.OutilsGestionConnexionReseau;
import fr.alcyons.phimr4.Outils.OutilsGestionPDF;
        ...
        public void onClick(View v) {
            ...
            if(confirmer)
            {
                for(PH_Preparation ph_preparation_Selectionne : ph_preparation_List) {
                    ...
                    subject = "PhiMR4 - " + depot.getNom() + " - Livraisons N°" + ph_preparation_Selectionne.getUID() + " Refusé - " + date;
                    ...
                    if (email != null) {
                        new ListeLivraisonDepot.SendEmailTask().execute(email);
                        onBackPressed();
                    }
                }
            }
    ...
    View.OnClickListener onClickListenerValiderAllLivraison = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            for(PH_Preparation ph_preparation_Selectionne : ph_preparation_List) {
                ...
                subject = "PhiMR4 - " + depotNom + " - Livraisons N°" + ph_preparation_Selectionne.getUID() + " - " + date;
