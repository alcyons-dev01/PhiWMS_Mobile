...
public class DetailDemandeParticuliereActivity extends ServiceActivity {
  ...
  /*  Depot depot;
    ...
    // Fragment
    InformationDemandeParticuliere informationDemandeParticuliere;
    ListeDetailsDemandeParticuliere listeDetailsDemandeParticuliere;
    ...
    * *//*
    ...
    public View.OnClickListener clicBoutonSave = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            String motif = SaisieMotif.afficherAlerteEditText(DetailDemandeParticuliereActivity.this, "Saisir un motif", "Veuillez saisir un motif pour la demande particulère");
            ...
            String Commentaires = informationDemandeParticuliere.commentaire.getText().toString();
            String PreparationDate = "";
            String LivraisonPrevueDate = informationDemandeParticuliere.dateLivraisonProchaine.getText().toString();
            String DN_Groupe = "";
            double Montant_HT = 0;
            ...
            String Frequence = "";
            String previsionDateDebut = informationDemandeParticuliere.datePrevisionDu.getText().toString();
            String previsionDateFin = informationDemandeParticuliere.datePrevisionAu.getText().toString();
            Boolean URGENT = informationDemandeParticuliere.urgent.isChecked();
            String Motif = motif;
            ...
            for (Demande_PUI demande_pui : listeDetailsDemandeParticuliere.adapter.demandePuiList
                    ) {
            ...
            if (compteurReussite == listeDetailsDemandeParticuliere.adapter.demandePuiList.size()) {
                ...
                if (OutilsGestionConnexionReseau.isServerAccessible(DetailDemandeParticuliereActivity.this)) {
                    gestionnaireElementASynchroniser.toutSynchroniser(DetailDemandeParticuliereActivity.this, db, utilisateurConnecte.getToken());
                }

                Toast.makeText(DetailDemandeParticuliereActivity.this, "Demande Particulière effectuée", Toast.LENGTH_SHORT).show();
                DetailDemandeParticuliereActivity.this.finish();
                return;
            } else {
                Alerte.afficherAlerte(DetailDemandeParticuliereActivity.this, "Alerte", "Une erreur est survenue", "alerte");
    ...
    *//**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        *//* Code nécessaire à l'exécution du service *//*
        listeProduitID = intent.getExtras().getIntegerArrayList("listeProduit");
    ...
    *//**
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    informationDemandeParticuliere = new InformationDemandeParticuliere();
                    informationDemandeParticuliere.setParametres(dateInventaire, dateLivraisonProchaine, dateLivraisonSuivante);
                    informationDemandeParticuliere.setParametres(clicBoutonSave);
                    informationDemandeParticuliere.setParametres(depot);
                    return informationDemandeParticuliere;
                case 1:
                    listeDetailsDemandeParticuliere = new ListeDetailsDemandeParticuliere();
                    listeDetailsDemandeParticuliere.setParametres(listeProduitID, depot);
                    return listeDetailsDemandeParticuliere;
            }
            return null;
        }
