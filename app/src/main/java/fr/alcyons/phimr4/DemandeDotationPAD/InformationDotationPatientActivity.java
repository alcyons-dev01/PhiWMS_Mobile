...
public class InformationDotationPatientActivity extends ServiceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.information_demande_dotation_patient);
        ...
        ph_patient = PH_PatientOpenHelper.getPH_PatientByPhiMR4UUID(db, patientId);
        protocoles_patients = Protocoles_PatientsOpenHelper.getProtocoles_PatientsByIPP(db, ph_patient.getIPP());
        ...
        ((TextView) findViewById(R.id.nomDemande)).setText(depot.getNom().trim());
    ...
    public void onResume() {
        ...
        for (Dotation_Patient dotation_patient : Dotation_PatientOpenHelper.getDotation_PatientByProcotolesPatients(db, protocoles_patients.get_UID())) {
        ...
        // Initialisation de l'demandePuiAdapter puis transfere de l'demandePuiAdapter à la listeView pour l'affichage
        demandePuiAdapter = new Demande_PUIAdapter(InformationDotationPatientActivity.this, demandePuiList);
    ...
    public void onClick_Action_informations() {
        ...
        Alerte.afficherAlerteInfoDepot(InformationDotationPatientActivity.this, InformationDotationPatientActivity.this.getLayoutInflater(), depotNom, depotAdresse, depotTelephone, depotFax);
    }
    ...
    public void onClick_Action_prochaineLivraison() {
        ...
        datePrevisionDuTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePrevisionDuPickerDialog = new DatePickerDialog(InformationDotationPatientActivity.this, datePrevisionDuDatePicker, year, month, day);
        ...
        datePrevisionAuTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePrevisionAuPickerDialog = new DatePickerDialog(InformationDotationPatientActivity.this, datePrevisionAuDatePicker, year, month, day);
                ...
                if (!dateMinString.contentEquals("00/00/0000")) {
                    ...
                    datePrevisionAuPickerDialog = new DatePickerDialog(InformationDotationPatientActivity.this, datePrevisionAuDatePicker, year, month, day);
    ...
    public void onClick_Action_envoyerDemande() {
        ...
        if (confirmer) {
            ...
            ActionUtilisateur new_action_utilisateur = new ActionUtilisateur(actionId, utilisateurConnecte.getId(), date_string, serviceActuel.getId(), Integer.parseInt(ParametresServeurOpenHelper.getPortServeur(db)), "En attente", ph_preparation.getUID(), "", "Demande Dotation Patient");
            ...
            if (compteurReussite == demandePuiAdapter.demandePuiList.size()) {
                ...
                if (OutilsGestionConnexionReseau.isServerAccessible(InformationDotationPatientActivity.this)) {
                    ElementASynchroniserOpenHelper.toutSynchroniser(InformationDotationPatientActivity.this, db, utilisateurConnecte, true);
                }

                Toast.makeText(InformationDotationPatientActivity.this, "Demande Dotation Patient effectuée", Toast.LENGTH_SHORT).show();
                InformationDotationPatientActivity.this.finish();
                return;
            } else {
                Alerte.afficherAlerte(InformationDotationPatientActivity.this, "Alerte", "Une erreur est survenue", "alerte");
