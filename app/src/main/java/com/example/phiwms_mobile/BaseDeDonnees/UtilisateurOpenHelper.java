...
import static com.example.phiwms_mobile.BaseDeDonnees.ServiceOpenHelper.recupererListeServiceUtilisateur;
...
public class UtilisateurOpenHelper extends DBOpenHelper {
    ...
    public static Utilisateur getUtilisateurSelonCurseur(Cursor cursor, SQLiteDatabase db) {
        ...
        List<Service> servicesHabilites = recupererListeServiceUtilisateur(utilisateur, db);
