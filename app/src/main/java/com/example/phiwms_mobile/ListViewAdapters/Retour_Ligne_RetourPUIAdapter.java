...
import com.example.phiwms_mobile.Classes.Retour_Ligne_RetourPUI_Adapte;
...
public class Retour_Ligne_RetourPUIAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.row_retour_ligne_retour_pui_new, parent, false);
