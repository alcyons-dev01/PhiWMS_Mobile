...
import com.example.phiwms_mobile.ReceptionPUI.ListeLotReceptionPuiActivity;
...
public class Lot_Reception_PUIAdapter extends ArrayAdapter {
    ...
    public List<Lot_Reception_PUIViewHolder> viewHolderList;
    public Lot_Reception_PUIViewHolder viewHolder;
    Context context;
    SQLiteDatabase db;
    int phReliquatUID;
    ...
    public Lot_Reception_PUIAdapter(Context context, SQLiteDatabase db, List<PH_Reliquat_ReceptionPUI_Adapte.Lot> lotList, int phReliquatUID, boolean numero_serie_present, boolean ADH) {
        ...
        for (PH_Reliquat_ReceptionPUI_Adapte.Lot phReliquatLotReceptionPui : lotList) {
            viewHolderList.add(new Lot_Reception_PUIViewHolder());
        }
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder = (Lot_Reception_PUIViewHolder) convertView.getTag();
        if (viewHolder == null) {
        ...
        PH_Reliquat_ReceptionPUI_Adapte.Lot lot = (PH_Reliquat_ReceptionPUI_Adapte.Lot) getItem(position);
            ...
            else
            {
                ...
                viewHolder.qteSaisie.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ((ListeLotReceptionPuiActivity) context).ClickNumberPicker(position);
                    }
                });
    ...
    public void addView(PH_Reliquat_ReceptionPUI_Adapte phcourant, String numLot, String numSerie, String date, String resultat, String conditionnement)
    {
        PH_Reliquat_ReceptionPUI_Adapte.Lot nouveauLot = phcourant.new Lot(numLot, date, numSerie, resultat);
        ...
        PH_Reliquat_ReceptionPUI_Adapte.ZoneEtEmplacement zoneEtEmplacement = phcourant.new ZoneEtEmplacement(zone.getZoneID(), zone.getZoneName(), emplacement.get_UID(), emplacement.getAdressage(), Integer.parseInt(conditionnement));
    ...
    public static class DatePickerFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {
        Lot_Reception_PUIViewHolder viewHolder;
        SQLiteDatabase db;
        PH_Reliquat_ReceptionPUI_Adapte.Lot phReliquatLotReceptionPui;
        ...
        public void setViewHolder(Lot_Reception_PUIViewHolder view, SQLiteDatabase database, PH_Reliquat_ReceptionPUI_Adapte.Lot phReliquatLotReceptionPui) {
    ...
    public class Lot_Reception_PUIViewHolder {
