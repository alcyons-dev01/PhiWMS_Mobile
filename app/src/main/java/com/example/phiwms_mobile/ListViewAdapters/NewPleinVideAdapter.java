...
import com.example.phiwms_mobile.BaseDeDonnees.EVENTOpenHelper;
...
import com.example.phiwms_mobile.Classes.Detail_Dot;
...
public class NewPleinVideAdapter extends BaseAdapter {
    ...
    public NewPleinVideAdapter(Context context, SQLiteDatabase database, Utilisateur utilisateur) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        DotationViewHolder viewHolder = null;
        ...
        if (convertView == null) {
            ...
            switch (rowType) {
                case TYPE_ITEM:
                    ...
                    viewHolder.separateurQuantitePleinVide = (ImageView) convertView.findViewById(R.id.separateurQuantitePleinVide);
                    viewHolder.linearQuantitePleinVide = (LinearLayout) convertView.findViewById(R.id.linearQuantitePleinVide);
    ...
    private PH_Preparation CreationPhPreparation(Dotation dotation)
    {
        ...
        {
            int id = CreatePhPreparationLigneDetailPleinVide(detail_dot, dotation);
        }

        return ph_preparation;
    }

    public int CreatePhPreparationLigneDetailPleinVide(Detail_Dot detailDot, Dotation dotation)
    {
        int id = 0;
