...
import com.example.phiwms_mobile.ControleDesRetoursScannee.ListeLotsControleDesRetoursScaneeActivity;
            ...
            else
            {
                ...
                viewHolder.qteSaisie.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ((ListeLotsControleDesRetoursScaneeActivity) context).ClickNumberPicker(position);
                    }
                });
