...
import com.example.phiwms_mobile.Classes.Demande_PleinVide;
...
import com.example.phiwms_mobile.Classes.Stock;
...
public class Demande_PleinVideAdapter extends ArrayAdapter {
    ...
    private class Demande_PleinVideFilter extends Filter {
        @Override
