...
/**
 * Created by quentinlanusse on 07/08/2017.
 */

public class Lot_ControleDesRetoursAdapter extends ArrayAdapter {
    ...
    public Lot_ControleDesRetoursAdapter(Context context, List<Retour_Ligne_ControleRetour_Adapte.LotAdapte> lots, SQLiteDatabase db, Retour_Ligne_ControleRetour_Adapte retourLigneAdapte, String depotStructure) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        Stock_Lot_Emplacement_Light stockLotEmplacement = Stock_Lot_EmplacementLightOpenHelper.getStock_Lot_EmplacementByID(db, lotAdapte.getStockLotEmplacementID());

        if(lotAdapte!=null && stockLotEmplacement!=null){
            viewHolder.numLot.setText(stockLotEmplacement.getLot());
            viewHolder.numSerie.setText(stockLotEmplacement.getSerie());
