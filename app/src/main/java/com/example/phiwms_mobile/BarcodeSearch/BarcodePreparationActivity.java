...
import com.example.phiwms_mobile.BarcodeSearch.camera.CameraSourcePreview;
import com.example.phiwms_mobile.BarcodeSearch.camera.GraphicOverlay;
import com.example.phiwms_mobile.BarcodeSearch.contexte.NewControleRetourMultipleContext;
import com.example.phiwms_mobile.BarcodeSearch.contexte.NewControleRetourUniqueContext;
import com.example.phiwms_mobile.BarcodeSearch.contexte.NewReceptionPADContext;
import com.example.phiwms_mobile.BarcodeSearch.contexte.NewReceptionPUIContext;
import com.example.phiwms_mobile.BarcodeSearch.contexte.NewUniqueReceptionPUIContext;
import com.example.phiwms_mobile.BarcodeSearch.contexte.PreparationMultipleContext;
import com.example.phiwms_mobile.BarcodeSearch.contexte.PreparationSimpleContext;
import com.example.phiwms_mobile.BarcodeSearch.contexte.ReceptionPADContexte;
import com.example.phiwms_mobile.BarcodeSearch.negative.BarcodeCaptureNegativeActivity;
import com.example.phiwms_mobile.BaseDeDonnees.CommandeOpenHelper;
import com.example.phiwms_mobile.BaseDeDonnees.DepotOpenHelper;
import com.example.phiwms_mobile.BaseDeDonnees.EmplacementOpenHelper;
...
import com.example.phiwms_mobile.BaseDeDonnees.PreparationOpenHelper;
...
import com.example.phiwms_mobile.Classes.Depot_Emplacement;
...
import com.example.phiwms_mobile.Classes.PH_Reliquat_ReceptionPUI_Adapte;
import com.example.phiwms_mobile.Classes.Produit;
import com.example.phiwms_mobile.Classes.Retour_Ligne;
import com.example.phiwms_mobile.Classes.Retour_Ligne_ControleRetour_Adapte;
...
import static com.example.phiwms_mobile.Outils.CodesEchangesActivites.RESULT_ZONE;
import static com.example.phiwms_mobile.Outils.CodesEchangesActivites.RETOUR_CODE_EMPLACEMENT;
import static com.example.phiwms_mobile.Outils.CodesEchangesActivites.RETOUR_SCANNER;
  ...
  /*          stringList = intent.getExtras().getStringArrayList("stringList");
                ...
                case R.string.scannerContextPreparationSimple :
                    ...
                    ((TextView) findViewById(R.id.EmplacementLotProduit)).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            BarcodePreparationActivity.this.startActivityForResult(newIntent, RESULT_ZONE);
                        }
                    });
                        break;
                case R.string.scannerContextPreparationMultiple:
            ...
            public void onClick(View v) {
                ...
                switch (scannerContexteInt) {
                    case R.string.scannerContextPreparationSimple :
                        ...
                        break;
                    case R.string.scannerContextPreparationMultiple:
                        //preparationMultipleContext.ValiderScan(preparationMultipleContext.lot_courant);
        ...
        ((FloatingActionButton) findViewById(R.id.scannerMode)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int codeEchangesActivites = RETOUR_SCANNER;
                    ...
                    switch (requestCode)
                    {
                        case RESULT_ZONE:
                            ...
                            if(zoneid != -1)
                            {
                                ...
                                newIntent.putExtras(extras);
                                BarcodePreparationActivity.this.startActivityForResult(newIntent, RETOUR_CODE_EMPLACEMENT);
                            }
                            break;
                                ...
                                public void onClick(View view) {
                                   ...
                                   /* String title = lotCourant.getNumLot();
                                    ...
                                    DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            int qteAprès = (int)(aNumberPicker.getValue()*preparationSimpleContext.produit.getCond_distrib());
                        ...
                        if(preparationMultipleContext.lot_courant != null)
                        {
                            ...
                            ((LinearLayout) findViewById(R.id.layout_qte_saisie_lot_preparation)).setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            int qteAprès = (int)(aNumberPicker.getValue()*preparationMultipleContext.produit.getCond_distrib());
                                            //lotCourant.setQteSaisie(qteAprès);
                                            //((TextView) findViewById(R.id.QteDemandee)).setText(String.valueOf(ligne_courante.getQte_preparer()));
                    ...
                    if(newReceptionPUIContext.nouveau_lot != null && ((TextView) findViewById(R.id.EmplacementLotProduit)).getText().toString().contentEquals(""))
                    {
                        ...
                        ((LinearLayout) findViewById(R.id.layout_qte_saisie_lot_preparation)).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        int qteAprès = aNumberPicker.getValue()*newReceptionPUIContext.conditionnement_achat;
                    ...
                    if(newUniqueReceptionPUIContext.nouveau_lot != null)
                    {
                        ...
                        ((LinearLayout) findViewById(R.id.layout_qte_saisie_lot_preparation)).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        int qteAprès = aNumberPicker.getValue()*newUniqueReceptionPUIContext.conditionnement_achat;
                        ...
                        if(newReceptionPADContext.ph_reliquat_courant != null)
                        {
                            ...
                            ((LinearLayout) findViewById(R.id.layout_qte_saisie_lot_preparation)).setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            int qteAprès = aNumberPicker.getValue()*newReceptionPADContext.conditionnementAchat;
                ...
                if (newControleRetourUniqueContext.onTap(best.rawValue))
                {
                    ...
                    ((LinearLayout) findViewById(R.id.layout_qte_saisie_lot_preparation)).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    int qteAprès = aNumberPicker.getValue()*newControleRetourUniqueContext.conditionnementDistribution;
                ...
                if (newControleRetourMultipleContext.onTap(best.rawValue))
                {
                    ...
                    ((LinearLayout) findViewById(R.id.layout_qte_saisie_lot_preparation)).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    int qteAprès = aNumberPicker.getValue()*newControleRetourMultipleContext.conditionnementDistribution;
