...
import com.example.phiwms_mobile.BarcodeSearch.BarcodePreparationActivity;
import com.example.phiwms_mobile.BarcodeSearch.ScannerPreparationActivity;
...
public class NewReceptionPUIContext {
    ...
    public List<PH_Reliquat_ReceptionPUI_Adapte> list_reliquat_receptionPuiAdapte;
    ...
    public NewReceptionPUIContext(final Context context, final SQLiteDatabase db, Utilisateur utilisateurConnecte, List<String> ListeGTIN, int userId, int CommandeId, List<PH_Reliquat> liste_phreliquat, List<PH_Reliquat_ReceptionPUI_Adapte> list_reliquat_receptionPuiAdapte, Depot_Emplacement emplacementPrecedent, Produit produitPrecedent){
        ...
        if (data != null) {
            switch (requestCode) {
                case CodesEchangesActivites.RETOUR_SCANNER:
                    ...
                    list_reliquat_receptionPuiAdapte = (List<PH_Reliquat_ReceptionPUI_Adapte>) data.getExtras().getSerializable("reliquatAdapteList");
                    break;
            }
        }
    }
