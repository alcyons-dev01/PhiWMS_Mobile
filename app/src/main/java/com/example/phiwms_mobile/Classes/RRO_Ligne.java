...
public class RRO_Ligne implements Serializable, Comparable {
    ...
    public RRO_Ligne(JSONObject jsonObject) {
        try {
            ...
            this.Ref_Frs = recupererString(jsonObject.getString("Ref_Frs"));
            this.Type_Pdt = recupererString(jsonObject.getString("Type_Pdt"));
            ...
            this.Fournisseur = recupererString(jsonObject.getString("Fournisseur"));
