...
import com.example.phiwms_mobile.BaseDeDonnees.Parametres_SerialisationOpenHelper;
...
public class Parametres_Serialisation {
    ...
    public Parametres_Serialisation(JSONObject jsonObject){
        try{
            ...
            serveurAPI_host=recupererString(jsonObject.getString("serveurAPI_host"));
            serveurLDAP_host=recupererString(jsonObject.getString("serveurLDAP_host"));
            communicationDiffere=recupererBooleen(jsonObject,"communicationDiffere");
            dispenserReception=recupererBooleen(jsonObject,"dispenserReception");
            dispenserDelivrance=recupererBooleen(jsonObject,"dispenserDelivrance");
            stockParNumeroDeSerie=recupererBooleen(jsonObject,"stockParNumeroDeSerie");
            serveurLDAP_port=recupererString(jsonObject.getString("serveurLDAP_port"));
            serveurLDAP_login=recupererString(jsonObject.getString("serveurLDAP_login"));
            serveurLDAP_password=recupererString(jsonObject.getString("serveurLDAP_password"));
            serveurLDAP_nomDomaine=recupererString(jsonObject.getString("serveurLDAP_nomDomaine"));
            dossierVision=recupererString(jsonObject.getString("dossierVision"));
            franceMVO_identifiant=recupererString(jsonObject.getString("franceMVO_identifiant"));
            franceMVO_mdp=recupererString(jsonObject.getString("franceMVO_mdp"));
            franceMVO_tan=recupererString(jsonObject.getString("franceMVO_tan"));
            franceMVO_termesEtConditions=recupererBooleen(jsonObject,"franceMVO_termesEtConditions");
            moduleVision=recupererBooleen(jsonObject,"moduleVision");
    ...
    public Parametres_Serialisation(Cursor cursor){
        ...
        communicationDiffere=recupererBooleen(cursor, Parametres_SerialisationOpenHelper.Constantes.NUM_COL_COMMUNICATIONDIFFERE_PARAMETRES_SERIALISATION);
        dispenserReception=recupererBooleen(cursor, Parametres_SerialisationOpenHelper.Constantes.NUM_COL_DISPENSERRECEPTION_PARAMETRES_SERIALISATION);
        dispenserDelivrance=recupererBooleen(cursor, Parametres_SerialisationOpenHelper.Constantes.NUM_COL_DISPENSERDELIVRANCE_PARAMETRES_SERIALISATION);
        stockParNumeroDeSerie=recupererBooleen(cursor, Parametres_SerialisationOpenHelper.Constantes.NUM_COL_STOCKPARNUMERODESERIE_PARAMETRES_SERIALISATION);
        ...
        franceMVO_termesEtConditions=recupererBooleen(cursor, Parametres_SerialisationOpenHelper.Constantes.NUM_COL_FRANCEMVO_TERMESETCONDITIONS_PARAMETRES_SERIALISATION);
        moduleVision=recupererBooleen(cursor, Parametres_SerialisationOpenHelper.Constantes.NUM_COL_MODULEVISION_PARAMETRES_SERIALISATION);
    }
