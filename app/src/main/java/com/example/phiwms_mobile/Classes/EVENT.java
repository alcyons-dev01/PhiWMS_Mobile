...
public class EVENT implements Serializable, Comparable {
    ...
    public EVENT(JSONObject jsonObject) {
        try {
            ...
            this.Date_event = recupererString(jsonObject.getString("Date_event"));
            this.ID_Ressource = jsonObject.getInt("ID_Ressource");
            this.Jour_event = recupererString(jsonObject.getString("Jour_event"));
            this.Semaine_event = jsonObject.getInt("Semaine_event");
            this.mois_de = recupererString(jsonObject.getString("mois_de"));
            this.Jour_de = recupererString(jsonObject.getString("Jour_de"));
            this.annee_de = recupererString(jsonObject.getString("annee_de"));
            this.Mois_livraison = recupererString(jsonObject.getString("Mois_livraison"));
            this.moisReference = recupererString(jsonObject.getString("moisReference"));
