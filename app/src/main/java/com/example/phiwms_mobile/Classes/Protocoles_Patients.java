...
import com.example.phiwms_mobile.BaseDeDonnees.Protocoles_PatientsOpenHelper;
...
public class Protocoles_Patients implements Serializable, Comparable {
    ...
    public Protocoles_Patients(JSONObject jsonObject) {
        try {
            ...
            this.Protocole_Std = recupererString(jsonObject.getString("Protocole_Std"));
            this.IPP = recupererString(jsonObject.getString("IPP"));
            this.Rappel_traitement = recupererString(jsonObject.getString("Rappel_traitement"));
            ...
            this.Debut_Date = recupererString(jsonObject.getString("Debut_Date"));
            this.Fin_Date = recupererString(jsonObject.getString("Fin_Date"));
            this.Interruption = recupererBooleen(jsonObject, "Interruption");
            this.Patient_Identite = recupererString(jsonObject.getString("Patient_Identite"));
            this.Valorisation = jsonObject.getInt("Valorisation");
            this.Soins_A_Domicile = recupererBooleen(jsonObject, "Soins_A_Domicile");
            this.Dotation_Std = recupererString(jsonObject.getString("Dotation_Std"));
            this.Depot_Code = jsonObject.getInt("Depot_Code");
            this.Qte_par_session = recupererBooleen(jsonObject, "Qte_par_session");
            this.Tournee_Protocole = recupererString(jsonObject.getString("Tournee_Protocole"));
            this.Tournee_Dotation = recupererString(jsonObject.getString("Tournee_Dotation"));
            this.Archiver = recupererBooleen(jsonObject, "Archiver");
            ...
            this.Ordre_Prescription_ignorer = recupererBooleen(jsonObject, "Ordre_Prescription_ignorer");
            this.Serie_Lundi_1 = recupererString(jsonObject.getString("Serie_Lundi_1"));
            this.Serie_Mardi_2 = recupererString(jsonObject.getString("Serie_Mardi_2"));
            this.Serie_Mercredi_3 = recupererString(jsonObject.getString("Serie_Mercredi_3"));
            this.Serie_Jeudi_4 = recupererString(jsonObject.getString("Serie_Jeudi_4"));
            this.Serie_Vendredi_5 = recupererString(jsonObject.getString("Serie_Vendredi_5"));
            this.Serie_Samedi_6 = recupererString(jsonObject.getString("Serie_Samedi_6"));
            this.Serie_Dimanche_7 = recupererString(jsonObject.getString("Serie_Dimanche_7"));
            this.Livraison_A_domicile = recupererBooleen(jsonObject, "Livraison_A_domicile");
            this.Patient_ID = jsonObject.getInt("Patient_ID");
            this.Centre_Hospitalier_Rattachement = recupererString(jsonObject.getString("Centre_Hospitalier_Rattachement"));
            this.Nephrologue_Referent = recupererString(jsonObject.getString("Nephrologue_Referent"));
            this.Generaliste_Referent = recupererString(jsonObject.getString("Generaliste_Referent"));
            this.IDE = recupererString(jsonObject.getString("IDE"));
            ...
            this.Technique_Debut_Date = recupererString(jsonObject.getString("Technique_Debut_Date"));
            this.Interruption_Fin_Date = recupererString(jsonObject.getString("Interruption_Fin_Date"));
            this.Interruption_Motif = recupererString(jsonObject.getString("Interruption_Motif"));
            this.Arret_Definitif_Date = recupererString(jsonObject.getString("Arret_Definitif_Date"));
            this.Arret_Motif = recupererString(jsonObject.getString("Arret_Motif"));
            this.Traitement_Modalite = recupererString(jsonObject.getString("Traitement_Modalite"));
            this.Interruption_Debut_Date = recupererString(jsonObject.getString("Interruption_Debut_Date"));
            this.Validation_Pharmaceutique = recupererBooleen(jsonObject, "Validation_Pharmaceutique");
            this.Validation_Pharmaceutique_Date = recupererString(jsonObject.getString("Validation_Pharmaceutique_Date"));
            this.Validation_Pharmaceutique_Par = recupererString(jsonObject.getString("Validation_Pharmaceutique_Par"));
    ...
    public Protocoles_Patients(Cursor cursor) {
        ...
        this.Interruption = recupererBooleen(cursor, Protocoles_PatientsOpenHelper.Constantes.NUM_COL_INTERRUPTION_PROTOCOLES_PATIENTS);
        ...
        this.Soins_A_Domicile = recupererBooleen(cursor, Protocoles_PatientsOpenHelper.Constantes.NUM_COL_SOINS_A_DOMICILE_PROTOCOLES_PATIENTS);
        ...
        this.Qte_par_session = recupererBooleen(cursor, Protocoles_PatientsOpenHelper.Constantes.NUM_COL_QTE_PAR_SESSION_PROTOCOLES_PATIENTS);
        ...
        this.Archiver = recupererBooleen(cursor, Protocoles_PatientsOpenHelper.Constantes.NUM_COL_ARCHIVER_PROTOCOLES_PATIENTS);
        ...
        this.Ordre_Prescription_ignorer = recupererBooleen(cursor, Protocoles_PatientsOpenHelper.Constantes.NUM_COL_ORDRE_PRESCRIPTION_IGNORER_PROTOCOLES_PATIENTS);
        ...
        this.Livraison_A_domicile = recupererBooleen(cursor, Protocoles_PatientsOpenHelper.Constantes.NUM_COL_LIVRAISON_A_DOMICILE_PROTOCOLES_PATIENTS);
        ...
        this.Validation_Pharmaceutique = recupererBooleen(cursor, Protocoles_PatientsOpenHelper.Constantes.NUM_COL_VALIDATION_PHARMACEUTIQUE_PROTOCOLES_PATIENTS);
