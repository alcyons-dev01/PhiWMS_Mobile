...
import com.example.phiwms_mobile.BaseDeDonnees.PH_PatientOpenHelper;
...
public class PH_Patient implements Serializable, Comparable {
    ...
    public PH_Patient(JSONObject jsonObject) {
        try {
            ...
            this.Civilité = recupererString(jsonObject.getString("Civilité"));
            this.Nom_naissance = recupererString(jsonObject.getString("Nom_naissance"));
            this.Prénom = recupererString(jsonObject.getString("Prénom"));
            this.Adresse1 = recupererString(jsonObject.getString("Adresse1"));
            this.Adresse2 = recupererString(jsonObject.getString("Adresse2"));
            this.CP = recupererString(jsonObject.getString("CP"));
            this.Ville = recupererString(jsonObject.getString("Ville"));
            this.Tel1 = recupererString(jsonObject.getString("Tel1"));
            this.IPP = recupererString(jsonObject.getString("IPP"));
            this.Fax = recupererString(jsonObject.getString("Fax"));
            ...
            this.Adresse3 = recupererString(jsonObject.getString("Adresse3"));
            this.Tel_Professionnel = recupererString(jsonObject.getString("Tel_Professionnel"));
            this.Tel2 = recupererString(jsonObject.getString("Tel2"));
            this.Technique = recupererString(jsonObject.getString("Technique"));
            this.IPP_Fac = recupererString(jsonObject.getString("IPP_Fac"));
            this.IPP_DM = recupererString(jsonObject.getString("IPP_DM"));
            this.Nom_Marital = recupererString(jsonObject.getString("Nom_Marital"));
            this.Date_Naissance = recupererString(jsonObject.getString("Date_Naissance"));
            this.Matricule = recupererString(jsonObject.getString("Matricule"));
            this.Clef = recupererString(jsonObject.getString("Clef"));
            this.Lieu_Naissance = recupererString(jsonObject.getString("Lieu_Naissance"));
            this.Sexe_Masculin_Feminin = recupererBooleen(jsonObject, "Sexe_Masculin_Feminin");
            this.Fax_Professionnel = recupererString(jsonObject.getString("Fax_Professionnel"));
            this.Profession = recupererString(jsonObject.getString("Profession"));
            this.Nom_Usuel = recupererString(jsonObject.getString("Nom_Usuel"));
            this.Email = recupererString(jsonObject.getString("Email"));
            this.Ressource_Adr1 = recupererString(jsonObject.getString("Ressource_Adr1"));
            this.Ressource_Adr2 = recupererString(jsonObject.getString("Ressource_Adr2"));
            this.Ressource_CP = recupererString(jsonObject.getString("Ressource_CP"));
            this.Ressource_Ville = recupererString(jsonObject.getString("Ressource_Ville"));
            this.Personne_Ressource = recupererString(jsonObject.getString("Personne_Ressource"));
            this.Ressource_Tél = recupererString(jsonObject.getString("Ressource_Tél"));
            this.Ressource_Fax = recupererString(jsonObject.getString("Ressource_Fax"));
            this.Centre_Hospitalier = recupererString(jsonObject.getString("Centre_Hospitalier"));
            this.Praticien = recupererString(jsonObject.getString("Praticien"));
            this.Motif_Suspension_Traitement = recupererString(jsonObject.getString("Motif_Suspension_Traitement"));
            this.Detail_Etat_patient = recupererString(jsonObject.getString("Detail_Etat_patient"));
            this.Infirmier = recupererString(jsonObject.getString("Infirmier"));
            this.Inf_Adr1 = recupererString(jsonObject.getString("Inf_Adr1"));
            this.Inf_Adr2 = recupererString(jsonObject.getString("Inf_Adr2"));
            this.Inf_CP = recupererString(jsonObject.getString("Inf_CP"));
            this.Inf_Ville = recupererString(jsonObject.getString("Inf_Ville"));
            this.Inf_Fax = recupererString(jsonObject.getString("Inf_Fax"));
            this.Inf_Tél = recupererString(jsonObject.getString("Inf_Tél"));
            this.Inf_Email = recupererString(jsonObject.getString("Inf_Email"));
            this.Date_entree = recupererString(jsonObject.getString("Date_entree"));
            this.Date_Debut_Traitement = recupererString(jsonObject.getString("Date_Debut_Traitement"));
            this.Sous_Technique = recupererString(jsonObject.getString("Sous_Technique"));
            this.Approvisionnement = recupererString(jsonObject.getString("Approvisionnement"));
            this.Lieu_Traitement = recupererString(jsonObject.getString("Lieu_Traitement"));
            this.ID_Lieu_Traitement = jsonObject.getInt("ID_Lieu_Traitement");
            this.Ascenceur = recupererBooleen(jsonObject, "Ascenceur");
            this.Escalier = recupererString(jsonObject.getString("Escalier"));
            this.Etage = jsonObject.getInt("Etage");
            this.Dgicode = recupererString(jsonObject.getString("Dgicode"));
            this.Date_Etat = recupererString(jsonObject.getString("Date_Etat"));
            this.Archive = recupererBooleen(jsonObject, "Archive");
            this.Securite_Sociale = recupererString(jsonObject.getString("Securite_Sociale"));
            this.Autre_Tel = recupererString(jsonObject.getString("Autre_Tel"));
            this.Autre_Nom = recupererString(jsonObject.getString("Autre_Nom"));
            this.CPAM_Nom = recupererString(jsonObject.getString("CPAM_Nom"));
            this.CPAM_Adresse = recupererString(jsonObject.getString("CPAM_Adresse"));
            this.CPAM_CP = recupererString(jsonObject.getString("CPAM_CP"));
            this.CPAM_Ville = recupererString(jsonObject.getString("CPAM_Ville"));
            this.Poids = jsonObject.getInt("Poids");
            this.INSC = recupererString(jsonObject.getString("INSC"));
            this.Sexe = recupererString(jsonObject.getString("Sexe"));
            this.Pharmacie = recupererString(jsonObject.getString("Pharmacie"));
            this.Traitement_Modalite = recupererString(jsonObject.getString("Traitement_Modalite"));
            this.Photo_lien = recupererString(jsonObject.getString("Photo_lien"));
            this.Document_partage = recupererString(jsonObject.getString("Document_partage"));
            this.discipline_Medicale = recupererString(jsonObject.getString("discipline_Medicale"));
    ...
    public PH_Patient(Cursor cursor) {
        ...
        this.Sexe_Masculin_Feminin = recupererBooleen(cursor, PH_PatientOpenHelper.Constantes.NUM_COL_SEXE_MASCULIN_FEMININ_PH_PATIENT);
        ...
        this.Ascenceur = recupererBooleen(cursor, PH_PatientOpenHelper.Constantes.NUM_COL_ASCENCEUR_PH_PATIENT);
        ...
        this.Archive = recupererBooleen(cursor, PH_PatientOpenHelper.Constantes.NUM_COL_ARCHIVE_PH_PATIENT);
