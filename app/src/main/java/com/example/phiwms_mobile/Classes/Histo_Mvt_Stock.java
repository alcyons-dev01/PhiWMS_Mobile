...
public class Histo_Mvt_Stock implements Serializable, Comparable {
    ...
    public Histo_Mvt_Stock(Cursor cursor) {
        ...
        this.Retour_Frs = recupererBooleen(cursor, Histo_Mvt_StockOpenHelper.Constantes.NUM_COL_RETOUR_FRS_HISTO_MVT_STOCK);
        ...
        this.Liquidé = recupererBooleen(cursor, Histo_Mvt_StockOpenHelper.Constantes.NUM_COL_LIQUIDE_HISTO_MVT_STOCK);
