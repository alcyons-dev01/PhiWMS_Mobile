...
public class Depot_Emplacement implements Serializable, Comparable {
    ...
    public Depot_Emplacement(JSONObject depotEmplacementJson) {
        try {
            ...
            this.Adressage = recupererString(depotEmplacementJson.getString("Adressage"));
            this.Hall = recupererString(depotEmplacementJson.getString("Hall"));
            this.Paletier = recupererString(depotEmplacementJson.getString("Paletier"));
            this.Alveole = recupererString(depotEmplacementJson.getString("Alveole"));
            this.Niveau = recupererString(depotEmplacementJson.getString("Niveau"));
            this.ZoneID = depotEmplacementJson.getInt("ZoneID");
            this.DepotID = depotEmplacementJson.getInt("DepotID");
            this.Depot_Reference = recupererString(depotEmplacementJson.getString("Depot_Reference"));
            this.Code_GLN = recupererString(depotEmplacementJson.getString("Code_GLN"));
