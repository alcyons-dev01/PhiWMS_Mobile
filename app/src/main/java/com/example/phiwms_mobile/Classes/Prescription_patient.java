...
public class Prescription_patient {
    ...
    public Prescription_patient(JSONObject jsonObject) {
        try {
            ...
            this.Designation = recupererString(jsonObject.getString("Designation"));
            this.Cond = jsonObject.getInt("Cond");
            this.Quantite = jsonObject.getInt("Quantite");
            this.Rf_Frs = recupererString(jsonObject.getString("Rf_Frs"));
            ...
            this.Date_Début = recupererString(jsonObject.getString("Date_Début"));
            this.Date_Fin = recupererString(jsonObject.getString("Date_Fin"));
            this.L = recupererBooleen(jsonObject, "L");
            this.Ma = recupererBooleen(jsonObject, "Ma");
            this.Me = recupererBooleen(jsonObject, "Me");
            this.J = recupererBooleen(jsonObject, "J");
            this.V = recupererBooleen(jsonObject, "V");
            this.S = recupererBooleen(jsonObject, "S");
            this.D = recupererBooleen(jsonObject, "D");
            ...
            this.Prescripteur_Abrev = recupererString(jsonObject.getString("Prescripteur_Abrev"));
            this.Prescripteur_Nom = recupererString(jsonObject.getString("Prescripteur_Nom"));
            this.Nb_Semaine = jsonObject.getInt("Nb_Semaine");
            this.Voie = recupererString(jsonObject.getString("Voie"));
    ...
    public Prescription_patient(Cursor cursor) {
        ...
        this.Livraison_Directe = recupererBooleen(cursor, Prescription_patientOpenHelper.Constantes.NUM_COL_LIVRAISON_DIRECTE_PRESCRIPTION_PATIENT);
        ...
        this.L = recupererBooleen(cursor, Prescription_patientOpenHelper.Constantes.NUM_COL_L_PRESCRIPTION_PATIENT);
        this.Ma = recupererBooleen(cursor, Prescription_patientOpenHelper.Constantes.NUM_COL_MA_PRESCRIPTION_PATIENT);
        this.Me = recupererBooleen(cursor, Prescription_patientOpenHelper.Constantes.NUM_COL_ME_PRESCRIPTION_PATIENT);
        this.J = recupererBooleen(cursor, Prescription_patientOpenHelper.Constantes.NUM_COL_J_PRESCRIPTION_PATIENT);
        this.V = recupererBooleen(cursor, Prescription_patientOpenHelper.Constantes.NUM_COL_V_PRESCRIPTION_PATIENT);
        this.S = recupererBooleen(cursor, Prescription_patientOpenHelper.Constantes.NUM_COL_S_PRESCRIPTION_PATIENT);
        this.D = recupererBooleen(cursor, Prescription_patientOpenHelper.Constantes.NUM_COL_D_PRESCRIPTION_PATIENT);
