...
import com.example.phiwms_mobile.BaseDeDonnees.MVT_DepotsOpenHelper;
...
public class MVT_Depots {
    ...
    public MVT_Depots(JSONObject jsonObject) {
        try {
            ...
            Depot_Reference = recupererString(jsonObject.getString("Depot_Reference"));
            Code_dépot = jsonObject.getInt("Code_dépot");
            Code_produit = jsonObject.getInt("Code_produit");
            Référence_F = recupererString(jsonObject.getString("Référence_F"));
            PU_com = jsonObject.getInt("PU_com");
            Désignation = recupererString(jsonObject.getString("Désignation"));
            Unité = recupererString(jsonObject.getString("Unité"));
            Fournisseur = recupererString(jsonObject.getString("Fournisseur"));
            ...
            Reliquat = recupererBooleen(jsonObject, "Reliquat");
            Date_entrée = recupererString(jsonObject.getString("Date_entrée"));
            Select = recupererBooleen(jsonObject, "Select");
            Commande = recupererString(jsonObject.getString("Commande"));
            Date_com = recupererString(jsonObject.getString("Date_com"));
            Condi_achat = jsonObject.getInt("Condi_achat");
            Condi_distri = jsonObject.getInt("Condi_distri");
            Date_péremption = recupererString(jsonObject.getString("Date_péremption"));
            Num_lot = recupererString(jsonObject.getString("Num_lot"));
            Code_barre = recupererString(jsonObject.getString("Code_barre"));
            Péremption = recupererBooleen(jsonObject, "Péremption");
            ...
            Gratuits = recupererBooleen(jsonObject, "Gratuits");
            Devise = recupererString(jsonObject.getString("Devise"));
            ...
            Suivi_Par_Lot = recupererBooleen(jsonObject, "Suivi_Par_Lot");
    ...
    public MVT_Depots(Cursor cursor) {
        ...
        Reliquat = recupererBooleen(cursor, MVT_DepotsOpenHelper.Constantes.NUM_COL_RELIQUAT_MVT_DEPOTS);
        ...
        Péremption = recupererBooleen(cursor, MVT_DepotsOpenHelper.Constantes.NUM_COL_PEREMPTION_MVT_DEPOTS);
        ...
        Gratuits = recupererBooleen(cursor, MVT_DepotsOpenHelper.Constantes.NUM_COL_GRATUITS_MVT_DEPOTS);
        ...
        Suivi_Par_Lot = recupererBooleen(cursor, MVT_DepotsOpenHelper.Constantes.NUM_COL_SUIVI_PAR_LOT_MVT_DEPOTS);
