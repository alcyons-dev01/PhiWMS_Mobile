...
public class Detail_Dot implements Serializable, Comparable {
    ...
    public Detail_Dot(JSONObject jsonObject) {
        try {
            ...
            this.PleinVide_Adressage = recupererString(jsonObject.getString("PleinVide_Adressage"));
    ...
    public Detail_Dot(Cursor cursor) {
        ...
        this.Livraison_Directe = recupererBooleen(cursor, Detail_DotOpenHelper.Constantes.NUM_COL_LIVRAISON_DIRECTE_DETAIL_DOT);
