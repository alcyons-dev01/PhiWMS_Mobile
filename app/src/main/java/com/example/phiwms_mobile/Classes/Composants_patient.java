...
public class Composants_patient implements Serializable, Comparable {
    ...
    public Composants_patient(JSONObject jsonObject) {
        try {
            ...
            this.Désignation = recupererString(jsonObject.getString("Désignation"));
            this.Cond = jsonObject.getInt("Cond");
            this.Qté = jsonObject.getDouble("Qté");
            this.Ref_Four = recupererString(jsonObject.getString("Ref_Four"));
            this.Catégorie = recupererString(jsonObject.getString("Catégorie"));
    ...
    public Composants_patient(Cursor cursor) {
        ...
        this.Livraison_Directe = recupererBooleen(cursor, Composants_patientOpenHelper.Constantes.NUM_COL_LIVRAISON_DIRECTE_COMPOSANTS_PATIENT);
