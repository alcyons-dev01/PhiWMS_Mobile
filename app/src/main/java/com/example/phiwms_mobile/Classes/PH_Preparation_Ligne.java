...
*/
    ...
    public PH_Preparation_Ligne(JSONObject jsonObject) {
        try {
            ...
            this.SerieNumero = recupererString(jsonObject.getString("SerieNumero"));
            this.Verrouiller = true;
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    public PH_Preparation_Ligne(Cursor cursor) {
        ...
        this.Livrer = recupererBooleen(cursor, PH_Preparation_LigneOpenHelper.Constantes.NUM_COL_LIVRER_PH_PREPARATION_LIGNE);
        this.Valider = recupererBooleen(cursor, PH_Preparation_LigneOpenHelper.Constantes.NUM_COL_VALIDER_PH_PREPARATION_LIGNE);
        ...
        this.Suivi_Par_Serie = recupererBooleen(cursor, PH_Preparation_LigneOpenHelper.Constantes.NUM_COL_SUIVI_PAR_SERIE);
        this.Serialiser_Reception = recupererBooleen(cursor, PH_Preparation_LigneOpenHelper.Constantes.NUM_COL_SERIALISER_RECEPTION);
        ...
        this.Verrouiller = recupererBooleen(cursor, PH_Preparation_LigneOpenHelper.Constantes.NUM_COL_VERROUILLER);
